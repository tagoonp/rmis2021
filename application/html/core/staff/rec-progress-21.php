...
$strSQL = "SELECT COUNT(rp_id) cn FROM rec_progress WHERE rp_progress_status = '21' AND rp_sending_status = '1' AND rp_confirm_1 = '1' AND rp_delete_status = '0' AND rp_progress_id = 'closing'";
$res6 = $db->fetch($strSQL, false);
if(($res6) && ($res6['cn'] > 0)){ $c_closing = $res6['cn']; }

$strSQL = "SELECT COUNT(rp_id) cn FROM rec_progress WHERE rp_progress_status = '21' AND rp_sending_status = '1' AND rp_confirm_1 = '1'AND rp_delete_status = '0' AND rp_progress_id = 'terminate'";
