...
// $strSQL = "SELECT COUNT(rp_id) cn FROM rec_progress WHERE rp_progress_status = '1' AND rp_sending_status = '1' AND rp_confirm_1 = '0' AND rp_delete_status = '0' AND rp_progress_id = 'closing'";
$strSQL = "SELECT COUNT(rp_id) cn FROM rec_progress WHERE rp_progress_status IN ('17') AND rp_sending_status = '1' AND rp_delete_status = '0' AND rp_confirm_1 = '1'";
$res6 = $db->fetch($strSQL, false);
if(($res6) && ($res6['cn'] > 0)){ $c_closing = $res6['cn']; }

$strSQL = "SELECT COUNT(rp_id) cn FROM rec_progress WHERE rp_progress_status = '1' AND rp_sending_status = '1' AND rp_confirm_1 = '0'AND rp_delete_status = '0' AND rp_progress_id = 'terminate'";
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-12 mb-2 mt-1">
                    <h3 class="text-dark">รายงานที่รอขอข้อมูลเพิ่มเติม/ดำเนินการอื่น ๆ</h3>
                    <div class="breadcrumbs-top">
                        <div class="breadcrumb-wrapper d-none d-sm-block">
                            <ol class="breadcrumb p-0 mb-0 pl-1">
                                <li class="breadcrumb-item"><a href="./"><i class="bx bx-home-alt"></i></a></li>
                                <li class="breadcrumb-item active">รายงานที่รอขอข้อมูลเพิ่มเติม/ดำเนินการอื่น ๆ</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="card bg-white text-center">
                    <div class="card-body p-0">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="tab-pane show active  fade pb-3 p-0" id="pills-closing" role="tabpanel" aria-labelledby="pills-closing-tab">
                            <?php 
                                if($c_closing == 0){
                                    ?>
                                    <h4 class="card-title mt-3 text-dark">ไม่มีแบบรายงานรอตรวจสอบ</h4>
                                    <?php
                                }else{
                                    ?>
                                                ...
                                                foreach ($res['data'] as $row) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="vertical-align: top;">
                                                            <?php echo $row['rp_progress_id']."-".$row['rp_session']; ?>
                                                            <div>
                                                                <span class="badge badge-secondary round"><?php echo "REC.".$row['code_apdu']; ?></span>
                                                            </div>
                                                        </td>
                                                        <td style="vertical-align: top;" class="text-dark">
                                                            <?php 
                                                            if($row['title_th'] == '-'){
                                                                echo '<span class="text-dark">'.$row['title_en']."</span>";
                                                            }else{
                                                                echo '<span class="text-dark">'.$row['title_th']. "</span><br><small>(".$row['title_en'].")</small>";
                                                            }
                                                            ?>
                                                            <div style="font-size: 0.8em;">
                                                            หัวหน้าโครงการ : 
                                                            <?php 
                                                            $strSQL = "SELECT * FROM useraccount a INNER JOIN userinfo b ON a.id = b.user_id WHERE a.id_pm = '".$row['id_pm']."' LIMIT 1";
                                    ...
                                    <table class="table table-striped mt-3">
                                        ...
                                        <tbody>
                                            ...
                                            $strSQL = "SELECT * FROM rec_progress a INNER JOIN research b ON a.rp_id_rs = b.id_rs
                                                        ...
                                                        WHERE 
                                                        a.rp_sending_status = '1' 
                                                        AND a.rp_confirm_1 = '0' 
                                                        AND a.rp_progress_status = '1'
                                                        AND a.rp_delete_status = '0' 
                                                        AND a.rp_progress_id = 'terminate'";
                                            $res = $db->fetch($strSQL, true, false);
                                            if(($res) && ($res['status'])){
                                                foreach ($res['data'] as $row) {
                                                    ?>
