...
$strSQL = "SELECT COUNT(rp_id) cn FROM rec_progress WHERE rp_sending_status = '1' AND rp_confirm_1 = '0' AND rp_delete_status = '0' AND rp_progress_id = 'closing'";
                                                ...
                                                <table class="table table-striped mt-3">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $strSQL = "SELECT * FROM rec_progress a INNER JOIN research b ON a.rp_id_rs = b.id_rs
                                                                   ...
                                                                   WHERE 
                                                                   a.rp_sending_status = '1' AND a.rp_confirm_1 = '0' AND a.rp_delete_status = '0' AND a.rp_progress_id = 'closing'";
