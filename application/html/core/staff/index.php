                ...
                <section id="card-navigation">
                    <div class="row">
                        <div class="col-12 col-sm-4">
                            ...
                            ?> btn-lg btn-block" onclick="window.location = 'progress_btn1'"><i class="bx bx-check-double"></i> รายงานรอตรวจสอบความถูกต้อง <?php if($n > 0){ echo "(".$n.")"; } ?></button>
                            ...
                            ?> btn-lg btn-block"><i class="bx bx-pencil"></i> รายงานรอการแก้ไขจากนักวิจัย <?php if($n > 0){ echo "(".$n.")"; } ?></button>
                            ...
                            ?> btn-lg btn-block"><i class="bx bx-time"></i> รายงานรอดำเนินการโดยเจ้าหน้าที่ <?php if($n > 0){ echo "(".$n.")"; } ?></button>
                            ...
                            ?> btn-lg btn-block"><i class="bx bxs-comment-error"></i> รายงานรอสรุปข้อเสนอแนะ <?php if($n > 0){ echo "(".$n.")"; } ?></button>
                            ...
                            ?> btn-lg btn-block"><i class="bx bxs-group"></i> รายงานรอสรุปผลจากที่ประชุม <?php if($n > 0){ echo "(".$n.")"; } ?></button>
