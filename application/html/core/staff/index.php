    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                ...
                <h3 class="text-dark">รายงานโครงการต่อเนื่อง<br><small class="text-muted">(สำหรับเจ้าหน้าที่)</small></h3>
                    <div class="breadcrumbs-top">
                        <div class="breadcrumb-wrapper d-none d-sm-block">
                            <ol class="breadcrumb p-0 mb-0 pl-1">
                                <li class="active breadcrumb-item"><a href="./"><i class="bx bx-home-alt"></i> หน้าแรก</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <div class="content-body pt-0 mt-0" >
                <div class="row">
                    <div class="col-6 col-sm-3" style="padding: 0px 5px; cursor: pointer;">
                        <div class="card bg-white mb-1 text-center" style="box-shadow: none; " onclick="window.location = 'rec-progress-1'">
                            <div class="card-body py-2" style="min-height: 152px;">
                                ...
                                <div class="text-dark line-ellipsis">รายงานรอตรวจเอกสาร
                                <?php 
                    ...
                    <div class="col-6 col-sm-3" style="padding: 0px 5px; cursor: pointer;">
                        <div class="card bg-white mb-1 text-center" style="box-shadow: none; " onclick="window.location = 'app-22'">
                            <div class="card-body py-2" style="min-height: 152px;">
                                <div class="badge-circle badge-circle-lg badge-circle-success mx-auto mb-50">
                                    <i class="bx bx-file font-medium-5"></i>
                                </div>
                                <div class="text-dark line-ellipsis">รอออกใบรับรอง</div>
                                <?php 
                    ...
                    <div class="col-6 col-sm-3" style="padding: 0px 5px; cursor: pointer;">
                        <div class="card bg-white mb-1 text-center" style="box-shadow: none; " onclick="window.location = 'rec-progress-17'">
                            <div class="card-body py-2" style="min-height: 152px;">
                                <div class="badge-circle badge-circle-lg badge-circle-success mx-auto mb-50">
                                    <i class="bx bx-info-circle font-medium-5"></i>
                                </div>
                                <div class="text-dark line-ellipsis">รอขอข้อมูลเพิ่มเติมจาก PI/ดำเนินการอื่น ๆ
                                    <?php 
                                    $strSQL = "SELECT COUNT(*) cn FROM rec_progress WHERE rp_progress_status IN ('17') AND rp_sending_status = '1' AND rp_delete_status = '0' AND rp_confirm_1 = '1'";
                                    $recCheck =$db->fetch($strSQL, false);
                                    if(($recCheck) && ($recCheck['cn'] > 0))
                                    echo '<br><span class="badge round badge-danger" style="padding-left: 18px; padding-right: 18px; font-size: 1em; color: #fff !important; margin-top: 5px;">'.$recCheck['cn'].' โครงการ</span>';
                                    ?>
                    ...
                    <div class="col-6 col-sm-3" style="padding: 0px 5px; cursor: pointer;">
                        <div class="card bg-white mb-1 text-center" style="box-shadow: none; " onclick="window.location = 'app-users-list'">
                            <div class="card-body py-2" style="min-height: 152px;">
                                <div class="badge-circle badge-circle-lg badge-circle-success mx-auto mb-50">
                                    <i class="bx bx-user-plus font-medium-5"></i>
                                </div>
                                <div class="text-dark line-ellipsis">รอทาบทามกรรมการ</div>
                                <?php 
                    ...
                    <div class="col-6 col-sm-3" style="padding: 0px 5px; cursor: pointer;">
                        <div class="card bg-white mb-1 text-center" style="box-shadow: none; " onclick="window.location = 'rec-progress-21'">
                            <div class="card-body py-2" style="min-height: 152px;">
                                <div class="badge-circle badge-circle-lg badge-circle-success mx-auto mb-50">
                                    <i class="bx bx-paper-plane font-medium-5"></i>
                                </div>
                                <div class="text-dark line-ellipsis">รายงาน PI ส่งเอกสารเพิ่มเติม/ตอบข้อเสนอแนะ
                                <?php 
                    ...
                    <div class="col-6 col-sm-3" style="padding: 0px 5px; cursor: pointer;">
                        <div class="card bg-white mb-1 text-center" style="box-shadow: none; " onclick="window.location = 'app-users-list'">
                            <div class="card-body py-2" style="min-height: 152px;">
                                ...
                                <div class="text-dark line-ellipsis">รอ PI ตอบข้อเสนอแนะ/ข้อเอกสารเพิ่มเติม
                                <?php 
                                ...
                                $recCheck =$db->fetch($strSQL, false);
                                if(($recCheck) && ($recCheck['cn'] > 0))
                                echo '<br><span class="badge round badge-light-secondary" style="padding-left: 18px; padding-right: 18px; font-size: 1em; color: #fff !important; margin-top: 5px;">'.$recCheck['cn'].' โครงการ</span>';
                                ?>
                                </div>
                    ...
                    <div class="col-6 col-sm-3" style="padding: 0px 5px; cursor: pointer;">
                        <div class="card bg-white mb-1 text-center" style="box-shadow: none; " onclick="window.location = 'app-15'">
                            <div class="card-body py-2" style="min-height: 152px;">
                                <div class="badge-circle badge-circle-lg badge-circle-success mx-auto mb-50">
                                    <i class="bx bx-group font-medium-5"></i>
                                </div>
                                <div class="text-dark line-ellipsis">รอนำเข้าที่ประชุม</div>
                                <?php 
                    ...
                    <!-- <div class="col-6 col-sm-3" style="padding: 0px 5px; cursor: pointer;">
                        <div class="card bg-white mb-1 text-center" style="box-shadow: none; " onclick="window.location = 'app-users-list'">
                            <div class="card-body py-2" style="min-height: 152px;">
                                ...
                                <div class="text-dark line-ellipsis">รอดำเนินการอื่น ๆ</div>
                            </div>
                        </div>
                    </div> -->
                    <div class="col-6 col-sm-3" style="padding: 0px 5px; cursor: pointer;">
                        <div class="card bg-white mb-1 text-center" style="box-shadow: none; " onclick="window.location = 'app-23'">
                            <div class="card-body py-2" style="min-height: 152px;">
                                <div class="badge-circle badge-circle-lg badge-circle-success mx-auto mb-50">
                                    <i class="bx bxs-group font-medium-5"></i>
                                </div>
                                <div class="text-dark line-ellipsis">รอสรุปผลจากที่ประชุม</div>
                                <?php 
                    ...
                    <div class="col-6 col-sm-3" style="padding: 0px 5px; cursor: pointer;">
                        <div class="card bg-white mb-1 text-center" style="box-shadow: none; " onclick="window.location = 'app-all'">
                            <div class="card-body py-2" style="min-height: 152px;">
                                <div class="badge-circle badge-circle-lg badge-circle-success mx-auto mb-50">
                                    <i class="bx bx-menu font-medium-5"></i>
                                </div>
                                <div class="text-dark line-ellipsis">รายงานการดำเนินการวิจัยทั้งหมด</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-6 col-sm-3" style="padding: 0px 5px; cursor: pointer;">
                        <div class="card text-center" style="box-shadow: none; " onclick="window.location = 'app-all'">
                            <div class="card-body py-2" style="min-height: 152px;">
                                ...
                                <div class="text-dark line-ellipsis">โครงการที่ค้าง Final report</div>
                            </div>
                        </div>
                    </div> -->
