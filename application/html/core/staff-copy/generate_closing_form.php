...
$strSQL = "SELECT * FROM research WHERE id_rs IN (SELECT rp_id_rs FROM rec_progress WHERE rp_session = '$session_id')";
$resResearch = $db->fetch($strSQL, false);
$researchData = '';
if($resResearch){
    $researchData = $resResearch;
            ...
            <div class="content-header row">
                <div class="content-header-left col-12 mb-2 mt-1">
                    <div class="breadcrumbs-top">
                        <h5 class="content-header-title float-left pr-1 mb-0 text-dark">สร้างใบรับทราบ (Closing)</h5>
                            ...
                            <div class="card">
                                <div class="card-body p-0">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="p-2">
                                                <button class="btn btn-primary" onclick="window.location = 'approve_doc?session_id=<?php echo $session_id; ?>'">กลับหน้ารายการ</button>
                                            </div>
                                        </div>
                                        <div class="col-12 text-dark">
                                            <div class="p-3">
                                                <div class="text-center">
                                                    <img src="http://localhost/rmis/img/psu-bw-logo.jpg" alt="" width="100">
                                                    <h2 class="mt-2">Human Research Ethics Committee</h2>
                                                    <h3>Faculty of Medicine, Prince of Songkla University</h3>
                                                    <hr>
                                                    <h4>Final Report</h4>
                                                </div>

                                                <div class="row">
                                                    <div class="col-4">Principal Investigator : </div>
                                                    <div class="col-8"></div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-4">REC : </div>
                                                    <div class="col-8"><?php echo $researchData['code_apdu']; ?></div>
                                                </div>
                                                
                                                <div class="row">
                                                    <div class="col-4">Protocol Number : </div>
                                                    <div class="col-8"><?php echo $researchData['protocol_no']; ?></div>
                                                </div>

                                                <div class="row">
                                                    <div class="col-4">Protocol Title : </div>
                                                    <div class="col-8"><?php echo $researchData['title_en']; ?></div>
                                                </div>

                                                <div class="row mt-3">
                                                    <div class="col-12">
                                                        <p>The determination was (will be) documented in the meeting minutes of HREC meeting ……./………. agenda …………on ................ (date) ..……..</p>
                                                        <p>Have/has been reviewed and acknowledged by Human Research Ethics Committee (HREC) of Faculty of Medicine Prince of Songkla University.</p>
                                                        <p>The research documents will be kept for 3 years from the acknowledged date before the discard </p>
                                                    </div>
