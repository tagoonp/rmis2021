                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                <div class="col-8"><h4 class="py-50 text-dark">2. ความเห็นของกรรมการ</h4></div>
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable modal-dialog-centered modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="">ข้อเสนอแนะแนะ : <span class="text-danger">*</span></label>
                       ...
                       .always(function(snap){
                        ...
                        //    return ;
                            if(snap.status == 'Success'){
                                ...
                                if(snap.data.rac_q5 == '3'){
                                    $('#hinfo5').removeClass('dn'); $('#txtrComment5').val(snap.data.rac_q5_info)
                                }
                        ...
                        .always(function(snap){
                            ...
                            if(snap.status == 'Success'){
                                ...
                                snap.data.forEach(i => {
                                    ...
                                    $review_status = '<span class="badge badge-light-secondary round">ยังไม่ทำแบบประเมิน</span><br>'
                                    if(snap.review_status[$c] == 1){
                                        $review_status = '<span class="badge badge-light-success round">ทำแบบประเมินเรียบร้อยแล้ว</span><br>'
