...
$strSQL = "SELECT COUNT(rp_id) cn FROM rec_progress WHERE rp_id_ec = '".$_SESSION['rmis_uid']."' AND rp_sending_status = '1' AND rp_confirm_1 = '1' AND rp_delete_status = '0' AND rp_progress_id = 'closing'";
$res6 = $db->fetch($strSQL, false);
if(($res6) && ($res6['cn'] > 0)){ $c_closing = $res6['cn']; }

$strSQL = "SELECT COUNT(rp_id) cn FROM rec_progress WHERE rp_id_ec = '".$_SESSION['rmis_uid']."' AND rp_sending_status = '1' AND rp_confirm_1 = '1'AND rp_delete_status = '0' AND rp_progress_id = 'terminate'";
                                                ...
                                                <table class="table table-striped mt-3">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $strSQL = "SELECT * FROM rec_progress a INNER JOIN research b ON a.rp_id_rs = b.id_rs
                                                                   ...
                                                                   INNER JOIN useraccount d ON b.id_pm = d.id_pm
                                                                   ...
                                                                   AND a.rp_id_ec = '".$_SESSION['rmis_uid']."'
                                                                   ORDER BY a.rp_id";
                                                            ...
                                                            foreach ($res['data'] as $row) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="vertical-align: top;" class="text-dark">
                                                                        <div>
                                                                            <span class="badge badge-success mb-0 round"><?php echo "REC.".$row['code_apdu']; ?></span>
                                                                        </div>
                                                                        ...
                                                                        <div style="padding-top: 4px; font-size: 0.8em;" class="text-muted">
                                                                            หัวหน้าโครงการ : <?php 
