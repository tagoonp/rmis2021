                ...
                <section id="card-navigation">
                    <div class="row">
                        <div class="col-12 col-sm-4">
                            ...
                            $strSQL = "SELECT COUNT(*) cn FROM rec_progress WHERE rp_confirm_1 = '1' AND rp_progress_status = '3' AND rp_sending_status = '1' AND rp_delete_status = '0' AND rp_id_ec = '".$_SESSION['rmis_uid']."'";
                            ...
                            ?> btn-lg btn-block" onclick="window.location = 'progress_btn3'"><i class="bx bx-check-double"></i> รายงานรอตรวจและเลือกกรรมการ/ผู้เชี่ยวชาญอิสระ <?php if($n > 0){ echo "(".$n.")"; } ?></button>

                            <button class="btn text-left btn-<?php 
                            $strSQL = "SELECT COUNT(*) cn FROM rec_progress WHERE rp_progress_status IN ('2', '8', '20') AND rp_sending_status = '1' AND rp_delete_status = '0'";
                            $res = $db->fetch($strSQL,false);
                            $n = 0;
                            if(($res) && ($res['cn'] > 0)){
                                $n = $res['cn'];
                            ...
                            ?> btn-lg btn-block"><i class="bx bx-group"></i> รายงานรอเลือกกรรมการ/ผู้เชี่ยวชาญอิสระเพิ่มเติม <?php if($n > 0){ echo "(".$n.")"; } ?></button>


                            <button class="btn text-left btn-<?php 
                            $strSQL = "SELECT COUNT(*) cn FROM rec_progress WHERE rp_progress_status = '5' AND rp_sending_status = '1' AND rp_delete_status = '0' AND rp_confirm_1 = '1' AND rp_session IN (SELECT rai_session_id FROM rec_approval_info WHERE rai_ec_id = '".$_SESSION['rmis_uid']."' AND rai_sign_status = '0')";
                            $res = $db->fetch($strSQL,false);
                            $n = 0;
                            if(($res) && ($res['cn'] > 0)){
                                $n = $res['cn'];
                            ...
                            ?> btn-lg btn-block"><i class="bx bx-comment-error"></i> รายงานรอตรวจสอบผลจากกรรมการ/ผู้เชี่ยวชาญอิสระ <?php if($n > 0){ echo "(".$n.")"; } ?></button>

                            <button class="btn text-left btn-<?php 
                            $strSQL = "SELECT COUNT(*) cn FROM rec_progress WHERE rp_progress_status = '3' AND rp_sending_status = '1' AND rp_delete_status = '0' AND rp_confirm_1 = '1' AND rp_session IN (SELECT rai_session_id FROM rec_approval_info WHERE rai_ec_id = '".$_SESSION['rmis_uid']."' AND rai_sign_status = '0')";
                            $res = $db->fetch($strSQL,false);
                            $n = 0;
                            if(($res) && ($res['cn'] > 0)){
                                $n = $res['cn'];
                            ...
                            ?> btn-lg btn-block"><i class="bx bxs-pencil"></i> รายงานหลังแก้ไขตามข้อเสนอแนะ <?php if($n > 0){ echo "(".$n.")"; } ?></button>
                            ...
                            ?> btn-lg btn-block"><i class="bx bxs-search"></i> รายงานรอตรวจใบรับรอง <?php if($n > 0){ echo "(".$n.")"; } ?></button>

                            <button class="btn text-left btn-success btn-lg btn-block"><i class="bx bx-table"></i> รายงานการดำเนินการวิจัยทั้งหมด</button>
