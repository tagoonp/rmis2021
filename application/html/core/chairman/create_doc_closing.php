                                            ...
                                            <table class="table table-borderless text-dark table-sm">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td style="color: #000 !important; font-size: 16px; vertical-align: top;"><?php echo $rec_pi['lname_en']." ".$rec_pi['lname_en']; ?><a  href="Javascript:updatePi('<?php echo $rec_pi['user_id']; ?>')" class="float-right"><i class="bx bx-pencil"></i></a></td>
                                                    </tr>
                                                    <tr>
