...
$strSQL = "SELECT COUNT(*) cn FROM rec_progress WHERE rp_progress_status = '24' AND rp_sending_status = '1' AND rp_delete_status = '0' AND rp_confirm_1 = '1' AND rp_progress_id = 'closing' AND rp_session IN (SELECT rai_session_id FROM rec_approval_info WHERE rai_ec_id = '".$_SESSION['rmis_uid']."' AND rai_sign_status = '0')";
$res6 = $db->fetch($strSQL, false);
if(($res6) && ($res6['cn'] > 0)){ $c_closing = $res6['cn']; }

$strSQL = "SELECT COUNT(*) cn FROM rec_progress WHERE rp_progress_status = '24' AND rp_sending_status = '1' AND rp_delete_status = '0' AND rp_confirm_1 = '1' AND rp_progress_id = 'terminate' AND rp_session IN (SELECT rai_session_id FROM rec_approval_info WHERE rai_ec_id = '".$_SESSION['rmis_uid']."' AND rai_sign_status = '0')";
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-12 mb-2 mt-1">
                    <h3>โครงการที่รอตรวจใบรับรอง/รับทราบ</h3>
                    <div class="breadcrumbs-top">
                        <div class="breadcrumb-wrapper d-none d-sm-block">
                            <ol class="breadcrumb p-0 mb-0 pl-1">
                                <li class="breadcrumb-item"><a href="./"><i class="bx bx-home-alt"></i></a></li>
                                <li class="breadcrumb-item active">โครงการที่รอตรวจใบรับรอง/รับทราบ</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                        ...
                                        <table class="table table-striped mt-3">
                                            ...
                                            <tbody>
                                                ...
                                                $strSQL = "SELECT * FROM rec_progress a INNER JOIN research b ON a.rp_id_rs = b.id_rs
                                                            ...
                                                            WHERE 
                                                            a.rp_progress_status = '24' AND a.rp_sending_status = '1' AND a.rp_confirm_1 = '1' AND a.rp_delete_status = '0' AND a.rp_progress_id = 'closing' AND a.rp_session IN (SELECT rai_session_id FROM rec_approval_info WHERE rai_ec_id = '".$_SESSION['rmis_uid']."' AND rai_sign_status = '0')";
                                                ...
                                                if(($res) && ($res['status'])){
                                                    foreach ($res['data'] as $row) {
                                                        ...
                                                        <tr>
                                                            <td style="vertical-align: top;">
                                                                ...
                                                                <div>
                                                                    <a href="create_doc_<?php echo $row['rp_progress_id'] ;?>?id_rs=<?php echo $row['rp_id_rs'];?>&session_id=<?php echo $row['rp_session'];?>">
                                                    ...
                                                    <tr>
                                                        <td><?php 
                                                        //echo $strSQL; 
                                                        echo "ไม่พบใบรับรอง/รับทราบรอตรวจสอบ";
                                                        ?></td>
                                                    </tr>
                                                    <?php
                                                }
