    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-body" >
                <div class="row">
                    <div class="col-12 d-none d-sm-block pb-2"><h5>ระบบรายงานความก้าวหน้างานวิจัย (สำหรับเลขานุการสำนักงาน ฯ)</h5></div>
                    <div class="col-6 col-sm-3" style="padding: 0px 5px; cursor: pointer;">
                        <div class="card text-center" style="box-shadow: none; " onclick="window.location = 'progress_btn1'">
                            <div class="card-body py-1">
                                ...
                                <div class="text-muted line-ellipsis">รอตรวจและเลือก Reviewer</div>
                                <?php 
                    ...
                    <div class="col-6 col-sm-3" style="padding: 0px 5px; cursor: pointer;">
                        <div class="card text-center" style="box-shadow: none; " onclick="window.location = 'app-22'">
                            <div class="card-body py-1">
                                ...
                                <div class="text-muted line-ellipsis">รอเลือก Reviewer เพิ่มเติม</div>
                                <?php 
                    ...
                    <div class="col-6 col-sm-3" style="padding: 0px 5px; cursor: pointer;">
                        <div class="card text-center" style="box-shadow: none; " onclick="window.location = 'app-users-list'">
                            <div class="card-body py-1">
                                ...
                                <div class="text-muted line-ellipsis">รอตรวจผลจาก Reviewer</div>
                                <?php 
                    ...
                    <div class="col-6 col-sm-3" style="padding: 0px 5px; cursor: pointer;">
                        <div class="card text-center" style="box-shadow: none; " onclick="window.location = 'app-users-list'">
                            <div class="card-body py-1">
                                ...
                                <div class="text-muted line-ellipsis">รายงานหลังแก้ไขตามข้อเสนอแนะ</div>
                                <?php 
                    ...
                    <div class="col-6 col-sm-3" style="padding: 0px 5px; cursor: pointer;">
                        <div class="card text-center" style="box-shadow: none; " onclick="window.location = 'app-24'">
                            <div class="card-body py-1">
                                <div class="badge-circle badge-circle-lg badge-circle-light-success mx-auto mb-50">
                                    <i class="bx bx-file font-medium-5"></i>
                                </div>
                                <div class="text-muted line-ellipsis">รอตรวจใบรับรอง</div>
                                <?php 
