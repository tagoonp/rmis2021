...
$strSQL = "SELECT COUNT(rp_id) cn FROM rec_progress WHERE rp_sending_status = '1' AND rp_confirm_1 = '0'AND rp_delete_status = '0' AND rp_progress_id = 'terminate'";
...
<body class="vertical-layout vertical-menu-modern dark-layout 2-columns  navbar-sticky footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns" data-layout="dark-layout">
    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-12 mb-2 mt-2">
                    <h3 class="text-dark">โครงการที่รอตรวจสอบเอกสาร</h3>
                ...
                <div class="card bg-white text-center">
                    <div class="card-body p-0">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="tab-pane fade pb-3 show active " id="pills-closing" role="tabpanel" aria-labelledby="pills-closing-tab">
                            <?php 
                                if($c_closing == 0){
                                    ?>
                                    ...
                                    <table class="table table-striped mt-0">
                                        ...
                                        <tbody>
                                            ...
                                            $strSQL = "SELECT * FROM rec_progress a INNER JOIN research b ON a.rp_id_rs = b.id_rs
                                                        ...
                                                        AND a.rp_id_ec = '$uid'
                                                        AND a.rp_progress_status IN ('28')
                                                ...
                                                foreach ($res['data'] as $row) {
                                                    ...
                                                    <tr>
                                                        <td style="vertical-align: top;" class="text-left">
                                                            <button class="btn btn-icon btn-success" style="padding-bottom: 10px;" onclick="openFormEc('closing', '<?php echo $row['rp_id_rs'];?>', '<?php echo $row['rp_session'];?>')"><i class="bx bx-search"></i></button>
                                                        </td>
                                                        <td style="vertical-align: top;" class="text-dark">
                                                            <div>
                                                                <span class="badge badge-danger mb-1 round"><?php echo $row['rp_progress_id']; ?> - <?php echo $row['rp_session']; ?></span>
                                                            ...
                                                            if($row['title_th'] == '-'){
                                                                ...
                                                                echo $row['title_th']. "<br><small>(".$row['title_en'].")</small>";
                                                            }
                                                            ?>
                                                        </td>
