...
<body class="horizontal-layout horizontal-menu navbar-static dark-layout 2-columns   footer-static  " data-open="hover" data-menu="horizontal-menu" data-col="2-columns" data-layout="dark-layout">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="dn" id="hdReviewer">
                                                        ...
                                                        <div class="text-left">
                                                            <button class="btn btn-success" data-toggle="modal" data-target="#modalReviewer"><i class="bx bx-plus"></i> เลือกผู้เชี่ยวชาญอิสระ</button>
                                                                ...
                                                                <div class="modal-dialog modal-lg modal-dialog-scrollable modal-dialog-centered modal-dialog-centered modal-dialog-scrollable">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title" id="exampleModalCenterTitle">รายชื่อผู้เชี่ยวชาญอิสระ</h5>
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <table class="table table-striped" id="tableReviewer">
                                                                                <thead>
                                                                                    <tr>
                                                                                        <th style="width: 200px;">ผู้เชี่ยวชาญอิสระ</th>
                                                                                        <th>ประเภท</th>
                                                                                        <th></th>
                                                                                    </tr>
                                                                                </thead>
                                                                                <tbody>
                                                                                    ...
                                                                                    if(($resReviewer) && ($resReviewer['status'])){
                                                                                        ...
                                                                                        ?>
                                                                                        <tr>
                                                                                            <td colspan="2" class="text-center">ไม่พบรายชื่อผู้เชี่ยวชาญอิสระ</td>
                                                                                        </tr>
                                                                                        <?php
                                                                                    }
                                                                                    ?>
                                                        ...
                                                        <div class="table table-responsive">
                                                            <table class="table table-striped">
                                                                ...
                                                                <tbody id="reviewerList">
                                                                    <tr><td colspan="3" class="text-center">ยังไม่มีการเลือกผู้เชี่ยวชาญอิสระ</td></tr>
                                                                </tbody>
                                                            </table>
                                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                <div class="col-8"><h4 class="py-50 text-dark">ความเห็นของกรรมการ</h4></div>
                                                <div class="col-4 text-right"><button class="btn btn-primary"><i class="bx bx-plus"></i> เพิ่มความเห็นจากกรรมการ</button></div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <table class="table table-striped">
    ...
    <div class="modal fade" id="modalAssesment" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-scrollable modal-dialog-centered modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <label for="" style="font-size: 1.1em;">จำนวนอาสาสมัครที่เข้าร่วมโครงการวิจัยเป็นไปตามแผนที่วางไว้หรือไม่ <span class="text-danger">*</span></label>
                    <div class="form-group">
                    ...
                    <label for="" style="font-size: 1.1em;">การดำเนินงานเป็นไปตามโครงร่างการวิจัยที่รับรองหรือไม่ <span class="text-danger">*</span></label>
                    <div class="form-group">
                        <ul class="list-unstyled mb-0 mt-1">
                            <li class="d-inline-block mr-0 mb-1 dn">
                                <fieldset>
                    ...
                    <label for="" style="font-size: 1.1em;">ประโยชน์และผลกระทบต่ออาสาสมัครเหมาะสม <span class="text-danger">*</span></label>
                    <div class="form-group">
                        <ul class="list-unstyled mb-0 mt-1">
                            <li class="d-inline-block mr-0 mb-1 dn">
                                <fieldset>
                    ...
                    <label for="" style="font-size: 1.1em;">การดำเนินการที่เกี่ยวข้องกับอาสาสมัครหลังสิ้นสุดการวิจัยเหมาะสม <span class="text-danger">*</span></label>
                    <div class="form-group">
                        <ul class="list-unstyled mb-0 mt-1">
                            <li class="d-inline-block mr-0 mb-1 dn">
                                <fieldset>
                    ...
                    <label for="" style="font-size: 1.1em;">ผลการทบทวนรายงานฉบับสมบูรณ์หรือ manuscript <span class="text-danger">*</span></label>
                    <div class="form-group">
                        <ul class="list-unstyled mb-0 mt-1">
                            <li class="d-inline-block mr-0 mb-1 dn">
                                <fieldset>
                            ...
                            <li class="d-inline-block mr-2 mb-1">
                                <fieldset>
                                    <div class="radio radio-shadow">
                                        <input type="radio" id="txtrQ5_1" name="txtrQ5" value="1"  onclick="f9ass.checkClick('5', '1')">
                                        <label for="txtrQ5_1">ไม่มี information risk</label>
                                    </div>
                                </fieldset>
                            </li>
                            <li class="d-inline-block mr-2 mb-1">
                                <fieldset>
                                    <div class="radio radio-shadow">
                                        <input type="radio" id="txtrQ5_2" name="txtrQ5" value="2" onclick="f9ass.checkClick('5', '2')">
                                        <label for="txtrQ5_2">ไม่มีผลกระทบเชิงลบต่ออาสาสมัครและชุมชนเพื่อเผยแพร่ข้อมูล</label>
                                    </div>
                                </fieldset>
                            </li>
                            <li class="d-inline-block mr-2 mb-1">
                                <fieldset>
                                    <div class="radio radio-shadow">
                                        <input type="radio" id="txtrQ5_3" name="txtrQ5" value="3" onclick="f9ass.checkClick('5', '3')">
                                        <label for="txtrQ5_3">ยังไม่มีรายงานฉบับสมบูรณ์</label>
                                    </div>
                                </fieldset>
                            </li>
                        </ul>
                    ...
                    <label for="" style="font-size: 1.1em;">โครงการความเสี่ยงไม่เกินความเสี่ยงเล็กน้อยหรือเคยผ่านการพิจารณาแบบเร็ว (Expedited review)<span class="text-danger">*</span></label>
                    <div class="form-group">
                        <ul class="list-unstyled mb-0 mt-1">
                            <li class="d-inline-block mr-0 mb-1 dn">
                                <fieldset>
                                    <div class="radio radio-shadow">
                                        <input type="radio" id="txtrQ6_0" name="txtrQ6" checked value="na">
                                    </div>
                                </fieldset>
                            </li>
                            <li class="d-inline-block mr-2 mb-1">
                                <fieldset>
                                    <div class="radio radio-shadow">
                                        <input type="radio" id="txtrQ6_1" name="txtrQ6" value="1"  onclick="f9ass.checkClick('6', '1')">
                                        <label for="txtrQ6_1">ใช่</label>
                                    </div>
                                </fieldset>
                            </li>
                            <li class="d-inline-block mr-2 mb-1">
                                <fieldset>
                                    <div class="radio radio-shadow">
                                        <input type="radio" id="txtrQ6_2" name="txtrQ6" value="2" onclick="f9ass.checkClick('6', '2')">
                                        <label for="txtrQ6_2">ไม่ใช่</label>
                                    </div>
                                </fieldset>
                            </li>
                        </ul>

                        <div class="dn" id="hinfo6">
                            <div class="form-group">
                                <label for="">หมายเหตุ :</label>
                                <textarea name="txtrComment6" id="txtrComment6" cols="30" rows="5" class="form-control"></textarea>
                            </div>
                        </div>
                    ...
                    <label for="" style="font-size: 1.1em;">ความเห็นกรรมการ <span class="text-danger">*</span></label>
                    <div class="form-group">
                        <ul class="list-unstyled mb-0 mt-1">
                            <li class="d-inline-block mr-0 mb-1 dn">
                                <fieldset>
    ...
    <script>
                            ...
                            if(snap.status == 'Success'){
                                ...
                                snap.data.forEach(i => {
                                    ...
                                    if($('#txtUid').val() == i.rv_reviewer_id){
                                        $btnPencil = '<button class="btn btn-secondary btn-sm btn-icon" style="margin-right: 4px; padding-bottom: 13px; padding-top: 4px;" onclick="showModalAssesment()"><i class="bx bx-pencil"></i></button>'
                                    }
                                ...
                                $('#reviewerList').html('<tr><td colspan="3" class="text-center">ยังไม่มีการเลือกผู้เชี่ยวชาญอิสระ</td></tr>')
                            }
                        })
        }
        ...
        function deleteReviewer(id_rev, id_session, fname){
            Swal.fire({
                title: 'คำเตือน',
                text: "ยืนยันการลบ " + fname + " ออกจากรายการผู้เชี่ยวชาญอิสระสำหรับรายงานนี้หรือไม่",
                icon: 'warning',
