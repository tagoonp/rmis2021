                    ...
                    <div class="breadcrumbs-top">
                        <div class="breadcrumb-wrapper d-none d-sm-block">
                            <ol class="breadcrumb p-0 mb-0 pl-1">
                                ...
                                <li class="breadcrumb-item"><a href="./progressform_<?php echo $docinfo['rai_progress']; ?>?id_rs=<?php echo $id_rs;?>&session_id=<?php echo $session_id; ?>"><?php echo $docinfo['rai_progress']; ?>-<?php echo $session_id; ?></a></li>
                        ...
                        <div class="card-body">
                            ...
                            <div class="formDemo">
                                <table class="table table-borderless text-dark formDemo" >
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <textarea name="txtDoclist" id="txtDoclist" cols="30" rows="10" class="form-control"><?php echo $docinfo['rai_main_content']; ?></textarea>
                                        </td>
                                    </tr>
                                    <tr>
...
The determination was (will be) documented in the meeting minutes of HREC meeting <span id="time_meeting"  style="color: #000 !important; font-size: 16px;">............/........</span> agenda <span id="agenda_meeting"  style="color: #000 !important; font-size: 16px;">............</span> on <span id="date_meeting" style="color: #000 !important; font-size: 16px;">...................</span> <a href="Javascript:updateDocinfo('<?php echo $id_rs; ?>', '<?php echo $session_id; ?>')" class="float-right"><i class="bx bx-pencil"></i></a>
                                    ...
                                    <tr>
                                        ...
                                        Date <span class="text-danger" id="textSigndate"><?php if($docinfo){ echo date('d/m/Y', strtotime($docinfo['rai_sign_date'])); }else{ echo "-";} ?></span>
                            ...
                            <div class="text-center pt-3 pb-1">
                                <button class="btn btn-warning round" onclick="approval.sendToSign('closing')"><i class="bx bx-paper-plane mr-1"></i> ส่งเจ้าหน้าที่เพื่อแก้ไข</button>
                                <button class="btn btn-danger round" onclick="approval.sendToSign('closing')"><i class="bx bx-paper-plane mr-1"></i> ส่งประธานลงนาม</button>
                            </div>
                            </div>
                        </div>
                </div>
