                ...
                <section id="card-navigation">
                    <div class="row">
                        <div class="col-12 col-sm-4">
                            ...
                            ?> btn-lg btn-block" onclick="window.location = 'progress_btn3'"><i class="bx bx-check-double"></i> รายงานรอตรวจและเลือกผู้เชี่ยวชาญอิสระ <?php if($n > 0){ echo "(".$n.")"; } ?></button>
                            ...
                            ?> btn-lg btn-block"><i class="bx bx-group"></i> รายงานรอเลือกผู้เชี่ยวชาญอิสระเพิ่มเติม <?php if($n > 0){ echo "(".$n.")"; } ?></button>
                            ...
                            ?> btn-lg btn-block"><i class="bx bx-comment-error"></i> รายงานรอตรวจสอบผลจากผู้เชี่ยวชาญอิสระ <?php if($n > 0){ echo "(".$n.")"; } ?></button>
