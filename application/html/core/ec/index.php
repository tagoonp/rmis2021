    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                ...
                <h3 class="text-dark">รายงานโครงการต่อเนื่อง<br><small class="text-dark">(สำหรับเลขานุการ)</small></h3>
            ...
            <div class="content-body pt-0 mt-0" >
                <div class="row">
                    <div class="col-6 col-sm-3" style="padding: 0px 5px; cursor: pointer;">
                        <div class="card bg-white mb-1 text-dark text-center" style="box-shadow: none; " onclick="window.location = 'progress_btn1'">
                            <div class="card-body py-2" style="min-height: 152px;">
                                ...
                                <div class="text-dark line-ellipsis">รอตรวจและเลือก Reviewer
                                <?php 
                                $strSQL = "SELECT COUNT(*) cn FROM rec_progress 
                                          WHERE rp_id_ec = '$uid' 
                                          AND rp_progress_status = '3' 
                    ...
                    <div class="col-6 col-sm-3" style="padding: 0px 5px; cursor: pointer;">
                        <div class="card bg-white mb-1 text-dark text-center" style="box-shadow: none; " onclick="window.location = 'app-22'">
                            <div class="card-body py-2" style="min-height: 152px;">
                                <div class="badge-circle badge-circle-lg badge-circle-success mx-auto mb-50">
                                    <i class="bx bx-user-plus font-medium-5"></i>
                                </div>
                                <div class="text-dark line-ellipsis">รอเลือก Reviewer เพิ่มเติม</div>
                                <?php 
                    ...
                    <div class="col-6 col-sm-3" style="padding: 0px 5px; cursor: pointer;">
                        <div class="card bg-white mb-1 text-dark text-center" style="box-shadow: none; " onclick="window.location = 'app-users-list'">
                            <div class="card-body py-2" style="min-height: 152px;">
                                <div class="badge-circle badge-circle-lg badge-circle-success mx-auto mb-50">
                                    <i class="bx bxs-comment-error font-medium-5"></i>
                                </div>
                                <div class="text-dark line-ellipsis">รอตรวจผลจาก Reviewer</div>
                                <?php 
                    ...
                    <div class="col-6 col-sm-3" style="padding: 0px 5px; cursor: pointer;">
                        <div class="card bg-white mb-1 text-dark text-center" style="box-shadow: none; " onclick="window.location = 'progress_btn28'">
                            <div class="card-body py-2" style="min-height: 152px;">
                                <div class="badge-circle badge-circle-lg badge-circle-success mx-auto mb-50">
                                    <i class="bx bx-list-check font-medium-5"></i>
                                </div>
                                <div class="text-dark line-ellipsis">รายงานหลังแก้ไขตามข้อเสนอแนะ/ขอข้อมูลเพิ่ม
                                <?php 
                                $strSQL = "SELECT COUNT(*) cn FROM rec_progress 
                                           WHERE rp_id_ec = '$uid' 
                                           AND rp_progress_status IN ('28') 
                                           AND rp_sending_status = '1' 
                                           AND rp_delete_status = '0' 
                                           AND rp_confirm_1 = '1'
                                           ";
                    ...
                    <div class="col-6 col-sm-3" style="padding: 0px 5px; cursor: pointer;">
                        <div class="card bg-white mb-1 text-dark text-center" style="box-shadow: none; " onclick="window.location = 'app-24'">
                            <div class="card-body py-2" style="min-height: 152px;">
                                <div class="badge-circle badge-circle-lg badge-circle-success mx-auto mb-50">
                                    <i class="bx bx-file font-medium-5"></i>
                                </div>
                                <div class="text-dark line-ellipsis">รอตรวจใบรับรอง</div>
                                <?php 
                                $strSQL = "SELECT COUNT(*) cn FROM rec_progress WHERE rp_progress_status = '24' AND rp_sending_status = '1' AND rp_delete_status = '0' AND rp_confirm_1 = '1' AND rp_session IN (SELECT rai_session_id FROM rec_approval_info WHERE rai_ec_id = '".$_SESSION['rmis_uid']."' AND rai_sign_status = '0')";
                                $recCheck =$db->fetch($strSQL, false);
                                if(($recCheck) && ($recCheck['cn'] > 0))
                                    echo '<span class="badge badge-pill badge-danger badge-up" style="padding-left: 8px; padding-right: 8px;">'.$recCheck['cn'].'</span>';
                                ?>
                    ...
                    <div class="col-6 col-sm-3" style="padding: 0px 5px; cursor: pointer;">
                        <div class="card bg-white  mb-1 text-dark text-center" style="box-shadow: none; " onclick="window.location = 'app-all'">
                            <div class="card-body py-2" style="min-height: 152px;">
                                <div class="badge-circle badge-circle-lg badge-circle-success mx-auto mb-50">
