                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-3">
                        ...
                        <div class="list-group">
                            ...
                            <button type="button" class="list-group-item list-group-item-action <?php if($stage == 8){ echo "active"; } ?>" onclick="window.location='research-info?id_rs=<?php echo $id_rs; ?>&stage=8'">8. Activity logs</button>
                        </div>

                        <h5 class="text-white mt-3">คำสั่งดำเนินการ</h5>
                        <div class="list-group">
                            <button type="button" class="list-group-item list-group-item-action"><i class="bx bx-list-ol"></i> ดูรายงานทั้งหมดของโครงการนี้</button>
                            <button type="button" class="list-group-item list-group-item-action"><i class="bx bx-user"></i> เปลี่ยนเลขา ฯ รับผิดชอบ</button>
                            <button type="button" class="list-group-item list-group-item-action"><i class="bx bx-trash"></i> ลบ/ถอนรายงานฉบับนี้</button>
                        </div>
