...
if(isset($_REQUEST['search_key'])){
    $searchkey = mysqli_real_escape_string($conn, $_REQUEST['search_key']);
}
    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="lines">
                ...
                <li class="active nav-item"><a href="./app-search"><i class="menu-livicon" data-icon="search"></i><span class="menu-title text-truncate" data-i18n="Email">ค้นหาข้อมูล</span></a></li>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-12 mb-2 mt-1">
                    <h3>ค้นหาโครงการวิจัย</h3>
                    <div class="breadcrumbs-top">
                        <div class="breadcrumb-wrapper d-none d-sm-block">
                            <ol class="breadcrumb p-0 mb-0 pl-1">
                                <li class="breadcrumb-item"><a href="./"><i class="bx bx-home-alt"></i></a></li>
                                <li class="breadcrumb-item active">ค้นหาโครงการวิจัย</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <!-- <label for="iconLeft">Left Icon</label> -->
                                <fieldset class="form-group position-relative has-icon-left">
                                    <input type="text" class="form-control" id="txtSearchbox2" value="<?php echo $searchkey; ?>" placeholder="ใส่คำค้นหาที่นี่ เช่น รหัส REC หรือ ชื่อ นามสกุล ของนักวิจัย แล้วกด enter" />
                                    <div class="form-control-position" style="padding-top: 7px;">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="table-responsive">
                                    <table class="table table-striped th zero-configuration" style="margin-top: 0px;">
                                         <thead>
                                            <tr>
                                                <th>ข้อมูลโครงการ</th>
                                            </tr>
                                        ...
                                        <tbody>
                                            ...
                                            if($searchkey == ''){
                                                ?>
                                                <tr>
                                                    <td><?php echo "ไม่พบข้อมูลที่ต้องการ กรุณาพิมพ์คำค้นหา"; ?></td>
                                                </tr>
                                                <?php
                                            }else{
                                                $strSQL = "SELECT * FROM research a INNER JOIN useraccount b ON a.id_pm = b.id_pm
                                                       ...
                                                       WHERE 
                                                       (a.title_th LIKE '%$searchkey%' OR a.title_en LIKE '%$searchkey%' OR c.fname LIKE '$searchkey%' OR c.lname LIKE '$searchkey%' OR a.code_apdu LIKE '$searchkey%' OR c.fname_en LIKE '$searchkey%' OR c.lname_en LIKE '$searchkey%')
                                                    ...
                                                    foreach ($res['data'] as $row) {
                                                        ...
                                                        <tr>
                                                            <td style="vertical-align: top;">
                                                                <div>
                                                                    <span class="badge badge-success mb-1 round"><?php echo $row['id_rs']; ?></span>
