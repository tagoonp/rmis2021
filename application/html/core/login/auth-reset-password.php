...
if(!(isset($_REQUEST['sid']))){
    echo "ไม่สามารถอ่านข้อมูลคำร้องขอได้";
    die();
}

$sid = mysqli_real_escape_string($conn, $_REQUEST['sid']);

$strSQL = "SELECT * FROM userresetpassword WHERE ur_token = '$sid' AND ur_inuse = '1' AND ur_done = '0'";
$res = $db->fetch($strSQL, false, false);
if($res){

}else{
    echo "ไม่พบข้อมูลคำร้องขอได้";
    die();
}
        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                ...
                <section id="auth-login" class="row flexbox-container">
                    <div class="col-xl-4 col-sm-4 col-11">
                                ...
                                <div class="col-md-12 col-12 px-0">
                                    <div class="card disable-rounded-right mb-0 p-2 h-100 d-flex justify-content-center">
                                        ...
                                        <div class="card-body pt-2">
                                            <h4 class="text-dark">ตั้งรหัสผ่านใหม่</h4>
                                            <form onsubmit="return false;" id="createPasswordForm" autocomplete="off">

                                                <div class="form-group mb-50 d-none">
                                                    <!-- <label class="text-bold-600" for="exampleInputEmail1">Email address</label> -->
                                                    <label class="control-label f500" for="val-username">ตั้งรหัสผ่านใหม่ <span class="text-danger">**</span></label>
                                                    <input type="text" class="form-control" id="txtSid" placeholder="Create new password" autofocus value="<?php echo $sid; ?>">
                                                </div>

                                                <div class="form-group mb-50">
                                                    <!-- <label class="text-bold-600" for="exampleInputEmail1">Email address</label> -->
                                                    <label class="control-label f500" for="val-username">ตั้งรหัสผ่านใหม่ <span class="text-danger">**</span></label>
                                                    <input type="password" class="form-control" id="txtPassword1" placeholder="Create new password" autofocus>
                                                </div>

                                                <div class="form-group mb-50">
                                                    <label class="control-label f500" for="val-username">กรอกรหัสผ่านใหม่อีกครั้ง <span class="text-danger">**</span></label>
                                                    <input type="password" class="form-control" id="txtPassword2" placeholder="Re-enter your new password" >
                                                </div>
                    
                                                <div class="text-right pb-1">
                                                    <div class="text-right"></div>
                                                </div>
                                                <button type="submit" class="btn btn-success glow w-100 position-relative">บันทึกรหัสผ่าน<i id="icon-arrow" class="bx bx-right-arrow-alt"></i></button>
                                            </form>
                                            <div class="row">
                                                <div class="col-12 pt-2">
                                                    <div class="text-center">
                                                            กลับไปยังหน้า <a href="./"> - เข้าสู่ระบบ -</a>
                                                        </div>
                                                </div>
