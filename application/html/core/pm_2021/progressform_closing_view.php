                                        ...
                                        <div class="mb-0">
                                            ...
                                            <ul class="list-unstyled mb-0">
                                                ...
                                                <li class="d-inline-block mr-2 mb-1">
                                                    <fieldset>
                                                        <div class="radio radio-success">
                                                            <input type="radio" name="radio_1" id="radio_1_1" value="1" disabled <?php if(($pgStatus) && ($resProgress['rp5_qs1'] == '1')){ echo "checked"; }?>>
                                                ...
                                                <li class="d-inline-block mr-2 mb-1">
                                                    <fieldset>
                                                        <div class="radio radio-success">
                                                            <input type="radio" name="radio_1" id="radio_1_2" value="0" disabled <?php if(($pgStatus) && ($resProgress['rp5_qs1'] == '0')){ echo "checked"; }?>>
                                            ...
                                            <div class="pt-0 mb-1 <?php if(($pgStatus) && ($resProgress['rp5_qs1'] == '1')){}else{ echo "dn"; }?>" id="hd1">
                                                <textarea name="txtQ1" id="txtQ1" cols="30" disabled rows="4" placeholder="ระบุหมายเหตุ" class="form-control text-dark bg-white"><?php if(($pgStatus) && ($resProgress['rp5_qs1'] == '1')){ echo $resProgress['rp5_qs1_remak']; } ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                                                ...
                                                                <div class="pt-1 mb-2 pl-2">
                                                                    <div class="form-group row align-items-center">
                                                                        ...
                                                                        <div class="col-lg-5 col-6">
                                                                            <input type="number" class="form-control" name="txtQ2_1" id="txtQ2_1" min="0" disabled value="<?php if($pgStatus){ echo $resProgress['rp5_qs2_1']; } ?>" />
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group row align-items-center">
                                                                        ...
                                                                        <div class="col-lg-5 col-6">
                                                                            <input type="number" class="form-control" name="txtQ2_2" id="txtQ2_2"  min="0" disabled value="<?php if($pgStatus){ echo $resProgress['rp5_qs2_2']; } ?>" />
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group row align-items-center">
                                                                        ...
                                                                        <div class="col-lg-5 col-6">
                                                                            <input type="number"  class="form-control" name="txtQ2_3" id="txtQ2_3" min="0" disabled value="<?php if($pgStatus){ echo $resProgress['rp5_qs2_3']; } ?>" />
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group row align-items-center">
                                                                        ...
                                                                        <div class="col-lg-5 col-6">
                                                                            <input type="number"  class="form-control" name="txtQ2_4" id="txtQ2_4" min="0" disabled value="<?php if($pgStatus){ echo $resProgress['rp5_qs2_4']; } ?>" />
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group row align-items-center">
                                                                        ...
                                                                        <div class="col-lg-5 col-6">
                                                                            <input type="number"  class="form-control" name="txtQ2_5" id="txtQ2_5" min="0" disabled value="<?php if($pgStatus){ echo $resProgress['rp5_qs2_5']; } ?>"/>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group row align-items-center">
                                                                        ...
                                                                        <div class="col-lg-5 col-6">
                                                                            <input type="number"  class="form-control" name="txtQ2_6" id="txtQ2_6" min="0" disabled value="<?php if($pgStatus){ echo $resProgress['rp5_qs2_6']; } ?>" />
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-12 pt-1">
                                                                        ...
                                                                        <div class="pt-1 mb-2 pl-2">
                                                                            <div class="form-group row align-items-center">
                                                                                ...
                                                                                <div class="col-lg-5 col-6">
                                                                                    <input type="number" id="txtQ3_1" class="form-control" name="txtQ3_1" disabled placeholder=""  min="0" value="<?php if($pgStatus){ echo $resProgress['rp5_qs3_1']; } ?>"  />
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="form-group row align-items-center">
                                                                                ...
                                                                                <div class="col-lg-5 col-6">
                                                                                    <input type="number" id="txtQ3_2" class="form-control" name="txtQ3_2" disabled placeholder=""  min="0" value="<?php if($pgStatus){ echo $resProgress['rp5_qs3_2']; } ?>"  />
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="form-group row align-items-center">
                                                                                ...
                                                                                <div class="col-lg-5 col-6">
                                                                                    <input type="number" id="txtQ3_3" class="form-control" name="txtQ3_3" disabled placeholder="" min="0" value="<?php if($pgStatus){ echo $resProgress['rp5_qs3_3']; } ?>"  />
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                ...
                                <div class="row">
                                        ...
                                        <div class="pt-2 pb-0">
                                            <ul class="list-unstyled mb-0">
                                                ...
                                                <li class="d-inline-block mr-2 mb-1">
                                                    <fieldset>
                                                        <div class="radio radio-success">
                                                            <input type="radio" name="radio_4" id="radio_4_1" value="0" disabled <?php if(($pgStatus) && ($resProgress['rp5_qs4'] == '0')){ echo "checked"; }?>>
                                                ...
                                                <li class="d-inline-block mr-2 mb-1">
                                                    <fieldset>
                                                        <div class="radio radio-success">
                                                            <input type="radio" name="radio_4" id="radio_4_2" value="1" disabled <?php if(($pgStatus) && ($resProgress['rp5_qs4'] == '1')){ echo "checked"; }?>>
                                        ...
                                        <div class="pt-2 pb-0">
                                            <ul class="list-unstyled mb-0">
                                                ...
                                                <li class="d-inline-block mr-2 mb-1">
                                                    <fieldset>
                                                        <div class="radio radio-success">
                                                            <input type="radio" name="radio_5" id="radio_5_1" value="0" disabled <?php if(($pgStatus) && ($resProgress['rp5_qs5'] == '0')){ echo "checked"; }?>>
                                                ...
                                                <li class="d-inline-block mr-2 mb-1">
                                                    <fieldset>
                                                        <div class="radio radio-success">
                                                            <input type="radio" name="radio_5" id="radio_5_2" value="1" disabled <?php if(($pgStatus) && ($resProgress['rp5_qs5'] == '1')){ echo "checked"; }?>>
                                        ...
                                        <div class="pt-2 pb-2 pl-2">
                                            <fieldset>
                                                ...
                                                <div class="radio mb-1 radio-success">
                                                    <input type="radio" class="checkbox-input" id="radio_6_1" name="radio_6" disabled value="0"  <?php if(($pgStatus) && ($resProgress['rp5_qs6'] == '0')){ echo "checked"; }?>>
                                                    <label for="radio_6_1" class="text-dark">โครงการไม่เกี่ยวข้องกับอาสาสมัคร</label>
                                                </div>
                                            </fieldset>
                                            <fieldset>
                                                <div class="radio mb-1 radio-success">
                                                    <input type="radio" class="checkbox-input" id="radio_6_2" name="radio_6" disabled value="1" <?php if(($pgStatus) && ($resProgress['rp5_qs6'] == '1')){ echo "checked"; }?>>
                                                    <label for="radio_6_2" class="text-dark">ไม่มีความเสี่ยง</label>
                                                </div>
                                            </fieldset>
                                            <fieldset>
                                                <div class="radio radio-success">
                                                    <input type="radio" class="checkbox-input" id="radio_6_3" name="radio_6" disabled value="2" <?php if(($pgStatus) && ($resProgress['rp5_qs6'] == '2')){ echo "checked"; }?>>
                                                ...
                                                <div class="pt-1 mb-2 <?php if(($pgStatus) && ($resProgress['rp5_qs6'] == '2')){}else{ echo "dn"; }?>"  id="hd63">
                                                    <textarea name="txtQ6" id="txtQ6" cols="30" rows="4" placeholder="ระบุแผนลดควาามเสี่ยง" disabled class="form-control bg-white text-dark"><?php if(($pgStatus) && ($resProgress['rp5_qs6'] == '2')){ echo $resProgress['rp5_qs6_info']; } ?></textarea>
                                                </div>
                                            </fieldset>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        ...
                                        <div class="pt-2 pb-2 pl-2">
                                            <fieldset>
                                                ...
                                                <div class="radio mb-1 radio-success">
                                                    <input type="radio" class="checkbox-input" id="radio_7_1" name="radio_7" value="0" disabled <?php if(($pgStatus) && ($resProgress['rp5_qs7'] == '0')){ echo "checked"; }?>>
                                                    <label for="radio_7_1" class="text-dark">โครงการไม่เกี่ยวข้องกับอาสาสมัคร</label>
                                                </div>
                                            </fieldset>
                                            <fieldset>
                                                <div class="radio mb-1 radio-success">
                                                    <input type="radio" class="checkbox-input" id="radio_7_2" name="radio_7" value="1" disabled <?php if(($pgStatus) && ($resProgress['rp5_qs7'] == '1')){ echo "checked"; }?>>
                                                ...
                                                <div class="pt-1 mb-2 <?php if(($pgStatus) && ($resProgress['rp5_qs7'] == '1')){}else{ echo "dn"; }?>" id="hd72">
                                                    <textarea name="txtQ7_1" id="txtQ7_1" cols="30" rows="4" placeholder="ระบุเหตุผล" disabled class="form-control bg-white text-dark"><?php if(($pgStatus) && ($resProgress['rp5_qs7'] == '1')){ echo $resProgress['rp5_qs7_info_1']; } ?></textarea>
                                                </div>
                                            </fieldset>
                                            <fieldset>
                                                <div class="radio radio-success">
                                                    <input type="radio" class="checkbox-input" id="radio_7_3" name="radio_7" value="2" disabled <?php if(($pgStatus) && ($resProgress['rp5_qs7'] == '2')){ echo "checked"; }?>>
                                                ...
                                                <div class="pt-1 mb-2 <?php if(($pgStatus) && ($resProgress['rp5_qs7'] == '2')){}else{ echo "dn"; }?>" id="hd73">
                                                    <textarea name="txtQ7_2" id="txtQ7_2" cols="30" rows="4" disabled placeholder="ระบุแผนการจัดการและดูแล" class="form-control bg-white text-dark"><?php if(($pgStatus) && ($resProgress['rp5_qs7'] == '2')){ echo $resProgress['rp5_qs7_info_2']; } ?></textarea>
                                                </div>
                                            </fieldset>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-group">
                                            <div class="mt-1" style="padding: 20px; border: dashed; border-radius: 10px; border-width: 1px 1px 1px 1px; border-color: #ccc;">
                                                <?php echo $resProgress['rp5_summarize']; ?>
                                            </div>
                                        </div>
                                    </div>
