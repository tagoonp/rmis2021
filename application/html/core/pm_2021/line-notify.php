...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>RMIS@MED Line notify setting</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-12 mb-2 mt-1 pl-sm-1 pr-sm-1 pl-3 pr-3 pt-2 pt-sm-0">
                    <h3 class="text-white">การแจ้งเตือนผ่านไลน์</h3>
            ...
            <div class="content-body" >
                <div class="row">
                    <div class="col-12 col-sm-8">
                        <h4>รายชื่อผู้รับการแจ้งเตือนผ่านไลน์จากบัญชีผู้ใช้งาน RMIS ของท่าน</h4>
                        <div class="p-1">
                            <div class="row">
                                <?php 
                                $strSQL = "SELECT * FROM account_line_integration WHERE ali_uid = '$uid'";
                                $resCheck = $db->fetch($strSQL, true, true);
                                if($resCheck){

                                }else{
                                    echo '<div class="col-12 p-2" style="border:dashed; border-width: 1px 1px 1px 1px; border-radius: 5px;">ไม่พบข้อมูลบัญชีไลน์ Notify</div>';
                                }
                                ?>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12 text-center">
                                <button class="btn btn-success" data-toggle="modal" data-target="#modalLine"><i class="bx bx-plus"></i> เพิ่มบัญชีไลน์เพื่อรับการแจ้งเตือน</button>
                            </div>
                        </div>
                    </div>

                    <div class="modal fade" id="modalLine" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                        <div class="modal-dialog modal-sm modal-dialog-centered modal-dialog-centered modal-dialog-scrollable">
                            <div class="modal-content">
                                <div class="modal-body">
                                    <div class="row">
                                            <div class="col-12 text-center">
                                                <img src="../../../img/ec_med_psu_qr_m.png" alt="First slide" style="width: 80%;">
                                            </div>
                                        </div>

                                    <div class="row">
                                        <div class="col-12 text-center pt-2">
                                            <h3><span class="text-white">ขั้นตอนที่ 1</span></h3>
                                            <p>Add line Official โดยการสแกน QR Code นี้ และทำการเพิ่มเพื่อน<br>(<i class="bx bx-user-plus"></i> Add)</p>
                                        </div>

                                        <div class="col-12 text-center pt-0 pl-2 pr-2">
                                            <button type="button" class="btn btn-primary btn-block" data-dismiss="modal" onclick="showModal2()">
                                                <i class="bx bx-check d-block d-sm-none"></i>
                                                <span class="d-none d-sm-block">ถัดไป</span>
                                            </button>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="modal fade" id="modalLine2" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                        <div class="modal-dialog modal-sm modal-dialog-centered modal-dialog-centered modal-dialog-scrollable">
                            <div class="modal-content">
                                <div class="modal-body">
                                    <div class="row">
                                            <div class="col-12 text-center">
                                                <img src="../../../img/rmis-noti-2.png" alt="First slide" style="width: 80%;">
                                            </div>
                                        </div>

                                    <div class="row">
                                        <div class="col-12 text-center pt-2">
                                        <h3><span class="text-white">ขั้นตอนที่ 2</span></h3>
                                            <p>กดเมนู "สมัครรับการแจ้งเตือน" และกรอกบัญชีผู้ใช้งาน RMIS ของท่านอีกครั้ง</p>
                                        </div>

                                        <div class="col-12 text-center pt-0 pl-2 pr-2">
                                            <button type="button" class="btn btn-primary btn-block" data-dismiss="modal" onclick="showModal3()">
                                                <i class="bx bx-check d-block d-sm-none"></i>
                                                <span class="d-none d-sm-block">ถัดไป</span>
                                            </button>
                                        </div>
                    ...
                    <div class="modal fade" id="modalLine3" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                        <div class="modal-dialog modal-sm modal-dialog-centered modal-dialog-centered modal-dialog-scrollable">
                            <div class="modal-content">
                                <div class="modal-body">
                                    <div class="row">
                                            <div class="col-12 text-center">
                                                <img src="../../../img/rmis-noti-3.png" alt="First slide" style="width: 80%;">
                                            </div>
                                        </div>

                                    <div class="row">
                                        <div class="col-12 text-center pt-2">
                                        <h3><span class="text-white">เพิ่มสำเร็จ</span></h3>
                                            <p>เมื่อสมัครรับการแจ้งเตือนเรียบร้อยแล้ว การแจ้งเตือนต่าง ๆ จะถูกส่งไปยัง Line OA นี้ด้วย</p>
                                        </div>

                                        <div class="col-12 text-center pt-0 pl-2 pr-2">
                                            <button type="button" class="btn btn-primary btn-block" data-dismiss="modal">
                                                <i class="bx bx-check d-block d-sm-none"></i>
                                                <span class="d-none d-sm-block">เสร็จสิ้น</span>
                                            </button>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-12 col-sm-4">
                        <div class="list-group list-group-flush">
                            <a href="line-notify" class="list-group-item list-group-item-action border-0 d-flex <?php if($stage == 1){ echo "active"; }?>">
                                <div class="list-icon">
                                    <i class="badge-circle badge-circle-light-secondary bx bx-bell mr-1 text-primary"></i>
                                </div>
                                <div class="list-content">
                                    <h5>ส่วนที่ 1 : </h5>
                                    <p class="mb-0">
                                        รายชื่อผู้รับการแจ้งเตือนผ่านไลน์
                                    </p>
                                </div>
                            </a>
                            <a href="line-notify-record" class="list-group-item list-group-item-action border-0 d-flex <?php if($stage == 2){ echo "active"; }?>">
                                <div class="list-icon">
                                    <i class="badge-circle badge-circle-light-secondary bx bx-menu mr-1 text-primary"></i>
                                </div>
                                <div class="list-content">
                                    <h5>ส่วนที่ 2 : </h5>
                                    <p class="mb-0">
                                    ประวัติข้อความแจ้งเตือน
                                    </p>
                                </div>
                            </a>
                        </div>
