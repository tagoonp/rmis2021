...
if((!isset($_REQUEST['id_rs'])) || ($_REQUEST['session_id'] == '')){
    $db->close();
    header("location:javascript://history.go(-1)");
    die();
}

$project_id = mysqli_real_escape_string($conn, $_REQUEST['id_rs']);
$psid = mysqli_real_escape_string($conn, $_REQUEST['session_id']);
