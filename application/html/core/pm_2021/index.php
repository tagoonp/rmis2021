    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="lines">
                ...
                <li class="active nav-item"><a href="./" class="text-white"><i class="menu-livicon" data-icon="home"></i><span class="menu-title text-truncate" data-i18n="Email">หน้าแรก</span></a></li>
                ...
                <li class="navigation-header text-truncate text-white"><span data-i18n="Support">สนับสนุน</span>
                </li>
                <li class="nav-item"><a href="page-knowledge-base" target="_blank" class="text-white"><i class="menu-livicon" data-icon="info-alt"></i><span class="menu-title text-truncate" data-i18n="Documentation">ข้อมูลการใช้งาน</span></a>
                </li>
                <li class="nav-item"><a href="https://rmis2.medicine.psu.ac.th/documentation/" target="_blank" class="text-white"><i class="menu-livicon" data-icon="morph-folder"></i><span class="menu-title text-truncate" data-i18n="Documentation">คู่มือการใช้งาน</span></a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-body pt-5 mt-1" >
                <div class="row">
                    <div class="col-12 pb-0 text-dark"><h5 class="text-dark">เสนอโครงการวิจัยใหม่ <small class="text-muted">(Submit new initial review)</small></h5></div>
                    <div class="col-6 col-sm-3" style="padding: 0px 5px; cursor: pointer;">
                        <div class="d-none d-sm-block">
                            <div class="card text-center mb-1"   data-toggle="modal" data-target="#modalStart">
                                <div class="card-body py-2" style="box-shadow: none; min-height: 152px;" data-toggle="tooltip" data-placement="top" title="ลงทะเบียนโครงการวิจัยใหม่">
                                    <div class="badge-circle badge-circle-lg badge-circle-success mx-auto mb-50">
                                        <i class="bx bx-plus font-medium-5"></i>
                                    </div>
                                    <div class="text-dark line-ellipsis">ลงทะเบียนโครงการวิจัยใหม่</div>
                                </div>
                            </div>
                        </div>
                        <div class="d-block d-sm-none">
                            <div class="card text-center mb-1" style="box-shadow: none;" onclick="nonSupportDevice()">
                                <div class="card-body py-2" style="min-height: 152px;" data-toggle="tooltip" data-placement="top" title="ลงทะเบียนโครงการวิจัยใหม่">
                                    <div class="badge-circle badge-circle-lg badge-circle-success mx-auto mb-50">
                                        <i class="bx bx-plus font-medium-5"></i>
                                    </div>
                                    <div class="text-dark line-ellipsis">ลงทะเบียนโครงการวิจัยใหม่</div>
                        ...
                        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-centered modal-dialog-scrollable">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-danger ml-1" onclick="window.location='research-register'">
                    ...
                    <div class="col-6 col-sm-3" style="padding: 0px 5px; cursor: pointer;">
                        <div class="card text-center mb-1" style="box-shadow: none; " onclick="window.location = 'research-unsend'" data-toggle="tooltip" data-placement="top" title="โครงการวิจัยที่ยังไม่ยืนยันการส่ง">
                            <div class="card-body py-2" style="min-height: 152px;">
                                <div class="badge-circle badge-circle-lg badge-circle-success mx-auto mb-50">
                                    <i class="bx bx-paper-plane font-medium-5"></i>
                                </div>
                                <div class="text-dark line-ellipsis">โครงการวิจัยที่ยังไม่ยืนยันการส่ง
                                <?php 
                                ...
                                if(($recCheck) && ($recCheck['cn'] > 0))
                                    echo '<br><span class="badge round badge-danger" style="padding-left: 18px; padding-right: 18px; font-size: 1em; color: #fff !important; margin-top: 5px;">'.$recCheck['cn'].' โครงการ</span>';
                                ?>
                                </div>
                    ...
                    <div class="col-6 col-sm-3" style="padding: 0px 5px; cursor: pointer;">
                        <div class="card text-center mb-1" style="box-shadow: none; " onclick="window.location = 'app-users-list'" data-toggle="tooltip" data-placement="top" title="แบบเสนอรอการแก้ไข/ตอบข้อเสนอแนะ/ขอเอกสารเพิ่มเติม">
                            <div class="card-body py-2" style="min-height: 152px;">
                                <div class="badge-circle badge-circle-lg badge-circle-success mx-auto mb-50">
                                    <i class="bx bx-pencil font-medium-5"></i>
                                </div>
                                <div class="text-dark line-ellipsis">แบบเสนอรอการแก้ไข/ตอบข้อเสนอแนะ</div>
                                <?php 
                                $strSQL = "SELECT COUNT(*) cn FROM research a INNER JOIN type_status_research b ON a.id_status_research = b.id_status_research
                                WHERE 
                                a.id_pm = '$my_id_pm' 
                                ...
                                AND a.sendding_status = 'N'
                                AND a.delete_flag = 'N' 
                                AND a.id_status_research IN ('2', '20') 
                                AND a.id_rs NOT IN (SELECT rd_id_rs FROM research_drop WHERE 1)";
                                $recCheck =$db->fetch($strSQL, false);
                                if(($recCheck) && ($recCheck['cn'] > 0))
                                    echo '<span class="badge badge-pill badge-danger badge-up" style="padding-left: 18px; padding-right: 18px;">'.$recCheck['cn'].'</span>';
                                ?>
                            </div>
                        </div>
                    </div>
                    <div class="col-6 col-sm-3" style="padding: 0px 5px; cursor: pointer;">
                        <div class="card text-center mb-1" style="box-shadow: none; " onclick="window.location = 'app-users-list'" data-toggle="tooltip" data-placement="top" title="โครงการที่อยู่ระหว่างการขอพิจารณาทั้งหมดของท่าน">
                        <div class="card-body py-2" style="min-height: 152px;">
                                <div class="badge-circle badge-circle-lg badge-circle-success mx-auto mb-50">
                                    <i class="bx bx-folder font-medium-5"></i>
                                </div>
                                <div class="text-dark line-ellipsis">โครงการที่อยู่ระหว่างการขอพิจารณาทั้งหมดของท่าน</div>
                                <?php 
                ...
                <div class="row">
                    <div class="col-12 text-white"><hr><h5 class="text-dark mt-2">รายงานโครงการที่กำลังดำเนินการวิจัย <small class="text-muted">(Continuing report)</small></h5></div>
                    <div class="col-6 col-sm-3" style="padding: 0px 5px; cursor: pointer;">
                        <div class="card text-center mb-1" style="box-shadow: none; " onclick="window.location = 'rec-all'">
                            <div class="card-body py-2" style="min-height: 152px;">
                                <div class="badge-circle badge-circle-lg badge-circle-success mx-auto mb-50">
                                    <i class="bx bxs-wrench font-medium-5"></i>
                                </div>
                                <div class="text-dark line-ellipsis">โครงการที่อยู่ระหว่างการวิจัยของท่าน<?php 
                                ...
                                $recCheck =$db->fetch($strSQL, false);
                                if(($recCheck) && ($recCheck['cn'] > 0))
                                    echo '<br><span class="badge round badge-light-secondary" style="padding-left: 18px; padding-right: 18px; font-size: 1em; color: #000 !important; margin-top: 5px;">'.$recCheck['cn'].' โครงการ</span>';
                                ?></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-6 col-sm-3" style="padding: 0px 5px; cursor: pointer;">
                        <div class="card text-center mb-1" style="box-shadow: none; " onclick="window.location = 'rec-waitprogress'">
                            <div class="card-body py-2" style="min-height: 152px;">
                                <div class="badge-circle badge-circle-lg badge-circle-success mx-auto mb-50">
                                    <i class="bx bxs-error font-medium-5"></i>
                                </div>
                                <div class="text-dark line-ellipsis">รายงานรอการแก้ไข/ตอบข้อเสนอแนะ
                                    <?php 
                                    ...
                                    $recCheck =$db->fetch($strSQL, false);
                                    if(($recCheck) && ($recCheck['cn'] > 0))
                                    echo '<br><span class="badge round badge-danger text-white" style="padding-left:1 8px; padding-right: 18px; font-size: 1em; margin-top: 5px;">'.$recCheck['cn'].' โครงการ</span>';
                                    ?>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-6 col-sm-3" style="padding: 0px 5px; cursor: pointer;">
                        <div class="card text-center mb-1" style="box-shadow: none; " onclick="window.location = 'rec-progress'">
                            <div class="card-body py-2" style="min-height: 152px;">
                                <div class="badge-circle badge-circle-lg badge-circle-success mx-auto mb-50">
                                    <i class="bx bxs-file font-medium-5"></i>
                                </div>
                                <div class="text-dark line-ellipsis">รายงานอยู่ระหว่างดำเนินการของท่าน
                                <?php 
                                $strSQL = "SELECT COUNT(*) cn FROM rec_progress 
                                           WHERE 
                                           rp_sending_status = '1' 
                                ...
                                $recCheck =$db->fetch($strSQL, false);
                                if(($recCheck) && ($recCheck['cn'] > 0))
                                echo '<br><span class="badge round badge-light-secondary" style="padding-left:1 8px; padding-right: 18px; font-size: 1em; color: #000 !important; margin-top: 5px;">'.$recCheck['cn'].' โครงการ</span>';
                                ?>
                                </div>
                ...
                <div class="row">
                    <div class="col-12 d-none d-sm-block"><hr><h5 class="text-dark mt-2">โครงการที่ปิดโครงการแล้ว <small class="text-muted">(Closed project)</small></h5></div>
                    <div class="col-6 col-sm-3" style="padding: 0px 5px; cursor: pointer;">
                        <div class="card text-center mb-1" style="box-shadow: none; " onclick="window.location = 'progress_btn1'">
                            <div class="card-body py-1">
                                <div class="badge-circle badge-circle-lg badge-circle-success mx-auto mb-50">
                                    <i class="bx bx-check-double font-medium-5"></i>
                                </div>
                                <div class="text-dark line-ellipsis">โครงการที่ปิดโครงการแล้ว</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12 d-none d-sm-block text-white"><hr><h5 class="text-dark mt-2">อื่น ๆ <small class="text-muted">(Other)</small></h5></div>
                    <div class="col-6 col-sm-3" style="padding: 0px 5px; cursor: pointer;">
                        <div class="card text-center mb-1" style="box-shadow: none; " onclick="window.location = 'research-all'">
                            <div class="card-body py-1">
                                <div class="badge-circle badge-circle-lg badge-circle-success mx-auto mb-50">
                                    <i class="bx bx-folder font-medium-5"></i>
                                </div>
                                <div class="text-dark line-ellipsis">โครงการวิจัยทั้งหมดของท่าน</div>
                            </div>
                        </div>
                    </div>

                    <div class="col-6 col-sm-3" style="padding: 0px 5px; cursor: pointer;">
                        <div class="card text-center" style="box-shadow: none; " onclick="nonAvailableAll()">
                            <div class="card-body py-1">
                                <div class="badge-circle badge-circle-lg badge-circle-success mx-auto mb-50">
                                    <i class="bx bx-world font-medium-5"></i>
                                </div>
                                <div class="text-dark line-ellipsis">Med@PSU Research Portal</div>
                            </div>
                        </div>
                    </div>

                    <div class="col-6 col-sm-3" style="padding: 0px 5px; cursor: pointer;">
                        <div class="card text-center mb-1" style="box-shadow: none; " onclick="window.location = 'line-notify'">
                            <div class="card-body py-1">
                                <div class="badge-circle badge-circle-lg badge-circle-success mx-auto mb-50">
                                    <i class="bx bxs-bell-ring font-medium-5"></i>
                                </div>
                                <div class="text-dark line-ellipsis">Line notify setting</div>
                            </div>
                        </div>
                    </div>
