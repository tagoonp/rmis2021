            ...
            <div class="content-body" >
                <div class="row">
                    <div class="col-12 col-sm-8">
                        <h4>ประวัติข้อความแจ้งเตือน</h4>
                        <div class="p-1">
                            <div class="row">
                                <?php 
                                $strSQL = "SELECT * FROM account_line_log WHERE all_uid = '$uid'";
                                $resCheck = $db->fetch($strSQL, true, true);
                                if($resCheck){

                                }else{
                                    echo '<div class="col-12 p-2" style="border:dashed; border-width: 1px 1px 1px 1px; border-radius: 5px;">ไม่พบข้อความขาเข้า</div>';
                                }
                                ?>
                            </div>
                        </div>
