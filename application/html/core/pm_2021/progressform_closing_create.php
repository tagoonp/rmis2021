...
<input type="hidden" id="txtOwnerId" value="<?php echo $resProgress0['rp_uid']; ?>">
...
<body class="vertical-layout vertical-menu-modern dark-layout 2-columns  navbar-sticky footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns" data-layout="dark-layout">
                ...
                <div class="card">
                    ...
                    <div class="card-body bg-white text-dark pt-2">
                        ...
                        if(($resProgress0['rp_progress_status'] == '2') || ($resProgress0['rp_progress_status'] == '20') ){
                            ...
                            $strSQL = "SELECT * FROM rec_comment WHERE recc_session_id = '".$resProgress0['rp_session']."' AND recc_q_end = '0'";
                            $resCheckQ = $db->fetch($strSQL, false, false);

                            if($resCheckQ){
                                ?>
                                <div class="row">
                                    <div class="col-12 offset-sm-3 pt-2">
                                        <button class="btn btn-danger" onclick="window.location='progress_form_comment?id_rs=<?php echo $id_rs; ?>&session_id=<?php echo $session_id; ?>'">คลิกที่นี่ เพื่อไปตอบข้อเสนอแนะ</button>
                                        <div class="text-danger pt-1">
                                            ** เมื่อท่านทำการตอบข้อเสนอแนะเรียบร้อยแล้ว ให้กลับมายังหน้านี้เพื่อทำการส่งกลับสำนักงาน
                                        </div>
                                    </div>
                                </div>
                                <?php
                        ...
                        <form action="#" >
                            <fieldset>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <hr>
                                        <span class="text-dark" style="font-size: 1.05em;">8. สรุปผลการศึกษา <span class="text-danger">ไม่เกิน 3000 คำ ประกอบด้วย Rationale, Objectives, Design, Methods, Results และ Conclusion</span><br><span class="text-danger"><small>(สำหรับโครงการ Multi-center หรือ ยังไม่ได้อัพโหลดไฟล์ในข้อที่ 6 หรือ 7 ให้กรอกข้อนี้)</small></span><br></span>
                                        <div class="form-group">
                                            <textarea name="txtQ9" id="txtQ9" cols="30" rows="10" class="form-control"><?php if($pgStatus){ echo $resProgress['rp5_summarize']; };?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <hr>
                                        <div class="row">
                                            <div class="col-12"><span class="text-dark" style="font-size: 1.05em;">9. เอกสารอื่น ๆ จากสถาบันที่มีข้อตกลงความร่วมมือ </span></div>
                                            <div class="col-12 text-left pt-1">
                                                <button class="btn btn-secondary" type="button"  onclick="showUploadModal('9')"><i class="bx bx-upload"></i> คลิกที่นี่เพื่ออัพโหลด</button>
                                            </div>
                                        </div>
    ...
    <script>
        ...
        getFileProgressSubmissionList($('#txtOwnerId').val(), $('#txtSessionID').val(), 'closing', '4')
        getFileProgressSubmissionList($('#txtOwnerId').val(), $('#txtSessionID').val(), 'closing', '5')
        getFileProgressSubmissionList($('#txtOwnerId').val(), $('#txtSessionID').val(), 'closing', '8')
        getFileProgressSubmissionList($('#txtOwnerId').val(), $('#txtSessionID').val(), 'closing', '9')
