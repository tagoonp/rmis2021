...
<body>
                ...
                <div class="col-12">
                    ...
                    <div class="card mt-3">
                        <div class="card-body p-0">
                            <div class="p-4">
                                <button class="btn btn-primary bsdn mr-1 mb-1" id="btnAction_1"  onclick="window.location='research_view_all_owner?uid=<?php echo $uid; ?>&role=<?php echo $role; ?>&id_rs=<?php echo $id_rs;?>'"><i class="fas fa-info-circle"></i> ข้อมูลเบื้องต้น</button>
                            ...
                            <table class="table table-striped table-bordered table-sm">
                                <tbody>
                                    <tr>
                                        <td style="width: 250px;" class="pl-3">รหัสลงทะเบียน</td>
                                        <td class="pl-3 text-danger" id="">
                                          <?php echo $dataResearch1['id_rs'];?>
                                          <input type="hidden" value="<?php echo $dataResearch1['id_rs'];?>" id="textId_rs">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="pl-3">REC.</td>
                                        <td class="pl-3 text-danger">
                                          <?php
                                          if( $dataResearch1['code_apdu'] != ''){
                                            echo $dataResearch1['code_apdu'];
                                          }else{
                                            echo "ยังไม่กำหนด";
                                          }
                                          ?>
                                    ...
                                    <tr>
                                        <td class="pl-3">ชื่อโครงการ (ภาษาไทย)</td>
                                        <td class="pl-3 text-dark" id="title_th"><?php echo $dataResearch1['title_th'];?></td>
                                    </tr>
                                    <tr>
                                        <td class="pl-3">Project title (English)</td>
                                        <td class="pl-3 text-dark" id="title_en"><?php echo $dataResearch1['title_en'];?></td>
                                    </tr>
                                    <tr>
                                        <td class="pl-3">คำสำคัญ</td>
                                        <td class="pl-3 text-dark">
                                            <div>ภาษาไทย : <?php echo $dataResearch1['keywords_th'];?></div>
                                            <div>English : <?php echo $dataResearch1['keywords_en'];?></div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="pl-3">ประเภทโครงการวิจัย</td>
                                        <td class="pl-3 text-dark"><?php echo $dataResearch1['type_name'];?></td>
                                    </tr>
                                    <tr>
                                        <td class="pl-3">ระยะเวลาโครงการ</td>
                                        <td class="pl-3 text-dark">
                                          เริ่มต้นโครงการ : <span class="text-primary"><?php echo DateThai($dataResearch1['start_date'], true); ?></span>  วันที่สิ้นสุด : <span class="text-primary"><?php echo DateThai($dataResearch1['finish_date'], true); ?></span><br>
                                          รวมระยะเวลาดำเนินการ : <span class="text-primary"><?php echo DateDiff($dataResearch1['start_date'], $dataResearch1['finish_date'], 'day'); ?></span> วัน
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="pl-3">งบประมาณ</td>
                                        <td class="pl-3 text-dark">
                                          <?php echo number_format($dataResearch1['budget'])." บาท";?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="pl-3">ทุนวิจัย</td>
                                        <td class="pl-3 text-dark">
                                        <?php
                                          if($dataResearch1['ts0'] == '0'){
                                            echo "เป็นโครงการวิจัยที่ไม่ได้ขอทุนจากแหล่งทุนใด ๆ";
                                          }else{
                                    ...
                                    <tr>
                                        <td class="pl-3">กลุ่มแหล่งทุน</td>
                                        <td class="pl-3 text-dark">
                                          <?php
                                          $fundCount = 0;
                                          if($dataResearch1['ts1'] == 1){
                                            echo "- ทุนวิจัยคณะแพทยศาสตร์<br>";
                                            $fundCount++;
                                          }
                                          if($dataResearch1['ts7'] == 1){
                                            echo "- ทุนภาคเอกชน (Industry Sponsored Trial)<br>";
                                            $fundCount++;
                                          }
                                          if($dataResearch1['ts2'] == 1){
                                            echo "- ทุนงบประมาณแผ่นดิน<br>";
                                            $fundCount++;
                                          }
                                          if($dataResearch1['ts3'] == 1){
                                            echo "- เงินรายได้มหาวิทยาลัย<br>";
                                            $fundCount++;
                                          }
                                          if($dataResearch1['ts4'] == 1){
                                            echo "- ทุนอื่นภายในประเทศ<br>";
                                            $fundCount++;
                                          }
                                          if($dataResearch1['ts5'] == 1){
                                            echo "- ทุนอื่นภายนอกประเทศ<br>";
                                            $fundCount++;
                                          }
                                          if($dataResearch1['ts6'] == 1){
                                            echo "- ทุนอื่น ๆ<br>";
                                            $fundCount++;
                                          }
                                    ...
                                    <tr>
                                        <td class="pl-3">ชื่อแหล่งทุน</td>
                                        <td class="pl-3 text-dark">
                                          <?php
                                           if($fundCount == 0){
                                            echo "ไม่มี";
                                           }else{
                                             echo $dataResearch1['source_funds'];
                                           }
                                           ?>
                                          </td>
                                    </tr>
                                    <tr>
                                        <td class="pl-3">ผู้ร่วมวิจัย</td>
                                        <td class="pl-3 text-dark">
                                          <?php
                                          $strSQL = "SELECT * FROM pm_team a
                                                     WHERE
                                                     (a.co_rs_id = '$id_rs' OR (a.co_sess_id IN (SELECT session_id FROM research WHERE id_rs = '$id_rs') AND a.co_sess_id IS NOT NULL))
                                                     ";
                                          $resultCopi = mysqli_query($conn, $strSQL);
                                          if(($resultCopi) && (mysqli_num_rows($resultCopi) > 0)){
                                             while($rowCopi = mysqli_fetch_array($resultCopi)){
                                               echo '- '.$rowCopi['co_fname']." ".$rowCopi['co_lname']." ( ".$rowCopi['co_job']." )<br>";
                                             }
                                          }else{
                                              echo "ไม่มีผู้ร่วมวิจัย";
                                          }
                                          ?>
                                        </td>
                                    </tr>
  ...
  <script src="../assets/custom/js/staff-progress-status-1.js?token=<?php echo $sysdateu; ?>"></script> <!-- Choose reviewer -->
  <script src="../assets/custom/js/staff-progress-status-4.js"></script> <!-- Choose reviewer -->
