      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1>โครงการวิจัยทั้งหมดของท่าน</h1>
          </div>

          <div class="section-body">
              <div class="card">
                  <div class="card-body">
                      <table class="table table-striped table-bordered- mb-0" id="table-1">
                          <thead>
                              <tr class="bg-primary">
                                  <th class="text-white text-center" style="width: 80px;">#</th>
                                  <th class="text-white" style="width: 180px;">รหัสลงทะเบียน</th>
                                    ...
                                    while($row = mysqli_fetch_array($result)){
                                        ...
                                        <tr>
                                            ...
                                            <td style="vertical-align: top; padding: 10px;" class="pb-3">
                                                ...
                                                <div class="pt-1">
                                                    <button class="btn btn-primary btn-icon btn-sm" style="box-shadow: none; width: 28px;" onclick="project.set2view('<?php echo $row['id_rs']; ?>', true)"><i class="fas fa-search"></i></button>
                                                    <?php
                                                    if(($row['id_status_research'] == 18) || ($row['id_status_research'] == 22)) {
                                                      ?>
                                                      <button class="btn btn-secondary btn-icon btn-sm" style="box-shadow: none; width: 28px;" disabled><i class="fas fa-times"></i></button>
                                                      <?php
                                                    }else{
                                                      ?>
