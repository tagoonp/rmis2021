...
<body>
      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1>แก้ไข/ตอบข้อเสนอแนะเสนอโครงการวิจัย <br><small>(Update Research registration)</small> </h1>
          </div>
                  ...
                  <div class="row">
                    <div class="col-12 col-sm-3">
                      <div class="list-group" id="list-tab" role="tablist">
                        ...
                        <a class="list-group-item dn list-group-item-action flex-column bdn" id="list-part6-list" data-toggle="list" href="#list-part6" role="tab">
                          <p class="mb-1">ส่วนที่ 5 : </p>
                          <div class="d-flex w-100 justify-content-between">
                            <h6 class="mb-1">ตอบข้อคำถาม</h6>
                            <span id="badge6" class="badge badge-danger text-white badge-pill dn" style="padding: 10px 9px; margin-top: -3px;"><i class="fas fa-check" style="margin-left: 2px;"></i></span>
                          </div>
                        </a>
                    ...
                    <div class="col-12 col-sm-9">
                      ...
                      <div class="alert alert-danger alert-dismissible show fade">
                        <div class="alert-body">
                          ...
                          ข้อเสนอแนะที่แสดงนี้ จะแสดงให้เห็นเฉพาะข้อเสนอแนะในรอบล่าสุดและรอบก่อนหน้าเท่านั้น
                        </div>
                      </div>
                      ...
                      <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active pt-0" id="list-part1" role="tabpanel" aria-labelledby="list-part1-list">
                          <div class="card">
                            ...
                            <div class="card-body">
                              ...
                              <div class="row">
                                <div class="col-12 col-sm-4">
                                    <label for="">วันที่คาดว่าจะเริ่มโครงการ <br><small>Estimate date to start project</small> <span class="text-danger">*</span></label>
                                </div>
                                <div class="col-12 col-sm-8">
                                  <div class="form-group">
                            ...
                            <div class="card-body">
                              <div class="" style="padding: 20px; background: rgb(242, 242, 242);">
                                ...
                                <hr>
                                <div class="remarkArea"><div class="text-center">ไม่มีข้อมูลการแจ้งเตือนของโครงการนี้</div></div>
                              </div>
                            </div>
                                  ...
                                  <table class="table table-striped">
                                    <thead>
                                      <tr class="bg-primary">
                                        ...
                                        <th class="text-white" style="width: 100px;">หน้าที่</th>
                        ...
                        <div class="tab-pane fade pt-0" id="list-part5" role="tabpanel" aria-labelledby="list-part5-list">
                          <h4 class="text-dark mt-4">ส่วนที่ 6 : อัพโหลดไฟล์เอกสารโครงการวิจัย</h4>
                        ...
                        <div class="tab-pane fade pt-0" id="list-part6" role="tabpanel" aria-labelledby="list-part6-list">


                          <div class="card">
                            <div class="card-header" style="background-: rgb(73, 82, 88);">
                              <h4 class="text-dark">ระเบียบวิธีวิจัย</h4>
                            </div>
                            <div class="card-body p-0">
                              <div class="commentSpan2" id="commentPart2">
                                <div class="pt-4 pb-5 text-center">
                                  <i class="fas fa-sync fa-spin text-primary" style="font-size: 3em;"></i>
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="card">
                            <div class="card-header" style="background-: rgb(73, 82, 88);">
                              <h4 class="text-dark">กระบวนการขอความยินยอม</h4>
                            </div>
                            <div class="card-body p-0">
                              <div class="commentSpan3" id="commentPart3">
                                <div class="pt-4 pb-5 text-center">
                                  <i class="fas fa-sync fa-spin text-primary" style="font-size: 3em;"></i>
                                </div>
                              </div>
                          ...
                          <div class="card">
                            <div class="card-header" style="background-: rgb(73, 82, 88);">
                              <h4 class="text-dark">อื่น ๆ</h4>
                            </div>
                            <div class="card-body p-0">
                              <div class="commentSpan4" id="commentPart4">
                                <div class="pt-4 pb-5 text-center">
                                  <i class="fas fa-sync fa-spin text-primary" style="font-size: 3em;"></i>
                                </div>
                              </div>
  ...
  <div class="modal fade" id="answerModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header pb-3 bg-primary">
          <h5 class="modal-title text-white" id="exampleModalLabel">ตอบข้อคำถาม/ข้อเสนอแนะ</h5>
          <button type="button" class="close text-white btnCloseModal" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          <label for="" style="font-size: 0.7em;" class="text-dark">ข้อคำถาม : </label>
          <div class="pb-3" id="textQuestion" style="font-size: 1.1em;">
            ไม่พบข้อคำถาม
          </div>
          <form onsubmit="return false;" class="answerForm">
            <div class="form-group dn">
              <input type="text" name="" value="" id="txtQuestionid" readonly>
            </div>
            <div class="form-group dn">
              <input type="text" name="" value="" id="txtQuestionpart" readonly>
            </div>
            <div class="form-group">
              <label for="">คำตอบหรือคำชี้แจง <span class="text-danger">**</span> : <span class="text-danger">(ถ้าไม่มีคำตอบหรือคำชี้แจง ให้ใส่เครื่องหมาย - )</span> </label>
              <textarea name="txtAnswer_1" id="txtAnswer_1" class="form-control" rows="8" cols="80"></textarea>
            </div>
            <div class="form-group">
              <label for="">ข้อความเดิม :</label>
              <textarea name="txtAnswer_2" id="txtAnswer_2" class="form-control" rows="8" cols="80"></textarea>
            </div>
            <div class="form-group">
              <label for="">ข้อความที่แก้ไข/เพิ่มเติม :</label>
              <textarea name="txtAnswer_3" id="txtAnswer_3" class="form-control" rows="8" cols="80"></textarea>
            </div>
            <div class="form-group">
              <label for="">ส่วนที่แก้ไข : (.........(ชื่อเอกสารที่แก้ไข)………….…… หน้าที่................ บรรทัดที่.............)</label>
              <textarea name="txtAnswer_4" id="txtAnswer_4" class="form-control" rows="8" cols="80"></textarea>
            </div>
          </form>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-primary bsdn" onclick="saveAnswer()">บันทึกคำตอบ</button>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header bg-danger">
          <h5 class="modal-title text-white pb-3" id="exampleModalLabel">มติการพิจารณาโครงการวิจัย</h5>
        ...
        <div class="modal-body">
          <p style="text-shadow: none !important;">
            มติการพิจารณาโครงการวิจัย คือ <strong class="text-danger">Minor modification (ไม่ต้องเข้าพิจารณาในกรรมการเต็มชุดรอบที่ 2 หากเลขานุการเห็นชอบการแก้ไขตามข้อเสนอแนะ)</strong>
            <ul>
              <li>ขอให้ตอบข้อชี้แจงของกรรมการในหน้า Response To EC Comments ให้ครบทุกช่อง </li>
              <li>ขอให้ <strong class="text-danger">Highlight สีอ่อน</strong> ส่วนที่แก้ไขในเอกสารทุกชุด และ<strong class="text-danger">เปลี่ยน version & date</strong> ที่หัว/ท้ายกระดาษให้เป็นปัจจุบัน</li>
              <li>Upload file เอกสารฉบับแก้ไขผ่านระบบ RMIS โดยไม่ต้องส่งเอกสารมายังสำนักงาน ยกเว้นสำนักงานจะร้องขอไปยังนักวิจัย (ทุกฉบับต้องมีการลงนามครบถ้วน)</li>
            </ul>
          </p>
  ...
  <div class="modal fade" id="modal3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p style="text-shadow: none !important;">
            มติการพิจารณาโครงการวิจัยการประชุมครั้งที่ <span class="returnAgn"></span> วันที่ <span class="returnDate"></span> วาระที่ <span class="returnVara"></span> (กรรมการชุดที่ <span class="returnSet"></span>) คือ <strong class="text-danger">Minor modification (ไม่ต้องเข้าพิจารณาในกรรมการเต็มชุดรอบที่ 2 หากเลขานุการเห็นชอบการแก้ไขตามข้อเสนอแนะ)</strong>
            <ul>
              <li>ขอให้ตอบข้อชี้แจงของกรรมการในหน้า Response To EC Comments ให้ครบทุกช่อง </li>
              <li>ขอให้ <strong class="text-danger">Highlight สีอ่อน</strong> ส่วนที่แก้ไขในเอกสารทุกชุด และ<strong class="text-danger">เปลี่ยน version & date</strong> ที่หัว/ท้ายกระดาษให้เป็นปัจจุบัน</li>
              <li>Upload file เอกสารฉบับแก้ไขผ่านระบบ RMIS โดยไม่ต้องส่งเอกสารมายังสำนักงาน ยกเว้นสำนักงานจะร้องขอไปยังนักวิจัย (ทุกฉบับต้องมีการลงนามครบถ้วน)</li>
  ...
  <div class="modal fade" id="modal4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p style="text-shadow: none !important;">
            มติการพิจารณาโครงการวิจัยการประชุมครั้งที่ <span class="returnAgn"></span> วันที่ <span class="returnDate"></span> วาระที่ <span class="returnVara"></span> (กรรมการชุดที่ <span class="returnSet"></span>) คือ <strong class="text-danger">Major modification (ปรับปรุงแก้ไขเพื่อนำเข้าพิจารณาในกรรมการเต็มชุดรอบที่สองใหม่อีกครั้ง) </strong>
            <ul>
              <li>ขอให้ตอบข้อชี้แจงของกรรมการในหน้า Response To EC Comments ให้ครบทุกช่อง </li>
              <li>ขอให้ <strong class="text-danger">Highlight สีอ่อน</strong> ส่วนที่แก้ไขในเอกสารทุกชุด และ<strong class="text-danger">เปลี่ยน version & date</strong> ที่หัว/ท้ายกระดาษให้เป็นปัจจุบัน</li>
              <li>Upload file เอกสารฉบับแก้ไขผ่านระบบ RMIS และจัดทำเอกสารฉบับแก้ไขจำนวน 14 ชุด เพื่อบรรจุเข้าพิจารณาในคณะกรรมการเต็มชุดรอบที่ 2 </li>
            </ul>
            (โปรดตรวจสอบให้แน่ใจว่าสำเนาเอกสาร 14 ชุดที่ให้กรรมการ เป็นชุดเดียวกับที่ upload ในระบบ RMIS และทุกฉบับต้องมีการลงนามครบถ้วน)
          </p>
  ...
  <script type="text/javascript" src="../node_modules/ckeditor_full/ckeditor.js"></script>
  ...
  <script src="../assets/custom/js/initial-progress.js"></script>
  ...
  <script>
      ...
      $(document).ready(function(){
          ...
          setInterval(function(){
            saveDraft()
            check_prev_comment = $('.remarkArea').html()
          }, 5000);
      })
      ...
      function checkNotification(){
        ...
        var jxxr = $.post(conf.api + 'general/research_register?stage=get_notification', param, function(){}, 'json')
                    .always(function(snap){
                      if(fnc.json_exist(snap)){
                        snap.forEach(i=>{
                          if(i.status == '2'){ // Expedited
                            $('#modal2').modal()
                          }else if(i.status == '3'){ // Minor fb
                            $('#modal3').modal()
                            $('.returnAgn').text(i.agn)
                            $('.returnVara').text(i.vara)
                            $('.returnDate').text(i.date)
                            $('.returnSet').text(i.set)
                          }else if(i.status == '4'){ // Major fb
                            $('#modal4').modal()
                            $('.returnAgn').text(i.agn)
                            $('.returnVara').text(i.vara)
                            $('.returnDate').text(i.date)
      ...
      function saveAnswer(){
        $ans_data_1 = ans_1.getData()
        $ans_data_2 = ans_2.getData()
        $ans_data_3 = ans_3.getData()
        $ans_data_4 = ans_4.getData()
        if($ans_data_1 == ''){
          swal("คำเตือน", "กรุณาตอบหรือให้คำชี้แจงก่อนทำการบันทึก", "error")
          return ;
        }
        ...
        var jxr = $.post(conf.api + 'general/comment_manage?stage=set_answer', param, function(){})
                   .always(function(resp){
                     ...
                     if(resp == 'Y'){
                       ...
                       preload.hide()
                       swal("เกิดข้อผิดพลาด", "ไม่สามารถบันทึกคำตอบหรือคำชี้แจงได้", "error")
                     }
                   })
      }

      function updateComment(id, part){
        $('#answerModal').modal()
        $('#txtQuestionpart').val(part)
        ...
        var jxr = $.post(conf.api + 'general/comment_manage?stage=get_comment_info', param, function(){}, 'json')
                   .always(function(snap){
                     if(fnc.json_exist(snap)){
                       snap.forEach(i=>{
                         $('#textQuestion').html(i.riwc_q)
                         ans_1.setData(i.riwc_a1)
                         ans_2.setData(i.riwc_a2)
                         ans_3.setData(i.riwc_a3)
                         ans_4.setData(i.riwc_a4)
                       })
                       preload.hide()
                     }else{
                       preload.hide()
