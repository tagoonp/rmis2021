      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <div class="container">
              <h1>ตั้งค่า <small>(Settings)</small> </h1>
            </div>
          </div>
                  ...
                  <div class="card">
                    <div class="card-body text-center">
                      <div class="text-center pt-5 pb-5">
                        <i class="fas fa-times" style="font-size: 5em;"></i>
                        <p>
                          ยังไม่เปิดให้ใช้งาน
                        </p>
                        <p>
                          <button type="button" class="btn btn-primary bsdn" onclick="window.location = './index?uid=<?php echo $uid;?>&role=<?php echo $role;?>'">กลับสู่หน้าแรก</button>
                        </p>
                      </div>
                    </div>
                  </div>
